...
*   **Buoyancy Height Adjustment:** Raised the ship's vertical offset from `+0.5` to `+9.5`. This correction ensures the ship's gunwale remains above the water surface even during wave peaks, achieving a more realistic draft of approximately 6 meters.
