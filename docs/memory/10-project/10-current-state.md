...
- OpenSpec/Buddy 仍是功能推进主线，但当前 active changes 已经从 6 月初的控制校正和智能助教提案扩展阶段，收束到统一 UI 治理门禁和二级导航迁移系列。React Doctor 错误清理系列已归档，覆盖 server、aria role、shared state/effect、interactive state/effect 和 resource state/effect。
