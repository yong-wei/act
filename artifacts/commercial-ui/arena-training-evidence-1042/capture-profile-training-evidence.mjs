  ...
  arenaPortfolio: {
    ...
    trainingSummary: {
      ...
      recentRuns: [
        ...
        {
          id: 'training-4',
          taskId: 'task-deep-water-heading-ctrl',
          taskTitle: 'Deep water heading control',
          scenarioId: 'deep-water-heading-preview',
          simulationRunId: 'simulation-run-4',
          qualityScore: 86,
          preview: true,
          officialEligible: false,
          trainedAt: '2026-07-22T00:00:00.000Z',
        },
        {
          id: 'training-5',
          taskId: 'task-cruise-roll-blackbox-identification',
          taskTitle: 'Cruise roll black-box identification',
          scenarioId: 'cruise-roll-controller-preview',
          simulationRunId: 'simulation-run-5',
          qualityScore: 80,
          preview: true,
          officialEligible: false,
