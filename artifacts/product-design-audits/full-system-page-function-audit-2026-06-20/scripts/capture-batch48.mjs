...
const screenshotDir = path.join(root, 'screenshots/84-function-state-flows-batch48-delivery-governance');
const manifestPath = path.join(root, 'screenshots/function-state-flows-batch48-manifest.json');
