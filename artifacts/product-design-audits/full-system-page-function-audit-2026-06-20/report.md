...
| `audit-remediation-admin-governance-workflows` | 管理员治理、用户导入、用户筛选导出、配置测试、统计导出 | `chapters/51-function-state-flows-batch43.md`、`chapters/53-function-state-flows-batch45.md`、`chapters/54-function-state-flows-batch46.md`、`chapters/56-function-state-flows-batch48.md` 至 `chapters/67-function-state-flows-batch59.md` | remediated 2026-06-29；证据：`remediation/audit-remediation-admin-governance-operation-states/evidence.md` |
