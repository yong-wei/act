...
| `path-comparison-desktop-light` | `/assessment/adaptive-practice` | `frequency-response-foundations` | desktop | light | desktop collapsed | collapsed | comparable path options | `02-path-selection-comparison.png` | `artifacts/commercial-ui/adaptive-path-product-qa-516/path-comparison-desktop-light.png` |
| `path-comparison-mobile-dark` | `/assessment/adaptive-practice` | `frequency-response-foundations` | mobile | dark | workspace command surface | collapsed | comparable path options | `02-path-selection-comparison.png` | `artifacts/commercial-ui/adaptive-path-product-qa-516/path-comparison-mobile-dark.png` |
