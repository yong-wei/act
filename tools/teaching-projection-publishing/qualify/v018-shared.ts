/** Shared helpers for inactive v0.18 qualification. */

import { mkdirSync, readFileSync, writeFileSync } from 'node:fs';
import path from 'node:path';

import { projectionSha256 } from '../../../src/lib/teaching-projection/hash';

export const V018_SNAPSHOT =
  'snap-1b64a853dda5668d83d0d2f09cadf72937330ced6aa49611f8027a9d5ec008ed';
export const V018_RELEASE_ID = 'ctr:release:control-theory-engineering-v0.18';
...
export const AUTHORITY_CANDIDATE_RELATIVE =
  'course-content/authoring/knowledge/authority/candidates/control-theory-engineering-v0.18';
export const TEACHING_CANDIDATE_RELATIVE =
  'course-content/authoring/knowledge/teaching-projection/candidates/control-theory-engineering-v0.18';
export const V018_RELEASE_RELATIVE =
