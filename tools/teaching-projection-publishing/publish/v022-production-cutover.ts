...
} from '../../../src/lib/actkg-envelope/composite-envelope-registry';
...
import { projectionCanonicalJson, projectionDigest } from '../../../src/lib/teaching-projection/hash';
import {
  V09_RELEASE_ID,
  asRecord,
} from '../qualify/v022-shared';
import { V022_NAMED_CONSUMERS } from '../qualify/v022-qualify-contract';
import { readFirstActivationJournal } from '../../../src/lib/knowledge-cutover/first-activation';
