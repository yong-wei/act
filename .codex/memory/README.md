...
状态: active
最后更新: 2026-03-19
摘要: 本目录用于保存适合跨会话复用的项目长期记忆，强调分层索引、渐进读取、最近摘要优先和主题隔离。
上游:
- [AGENTS.md](/Users/YW/Documents/Site/act.just.edu.cn/AGENTS.md)
...
本目录只存放适合被 Codex/Serena 反复读取的项目记忆，不承载以下内容：
...
1. 先读 [00-index.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/00-index.md)
2. 再读 [02-recent-summary.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/02-recent-summary.md)
3. 若任务已明确，再读 [01-reading-map.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/01-reading-map.md) 并进入对应主题
