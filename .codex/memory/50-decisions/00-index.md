...
下游:
- [ADR-2026-04-20-module4-optimization-chain.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/50-decisions/ADR-2026-04-20-module4-optimization-chain.md)
...
- 仅记录会长期影响代码结构、部署方式或业务主干的决策
- 每个 ADR 只回答一个决策问题
- 决策失效后不要硬删，改状态并链接替代决策
