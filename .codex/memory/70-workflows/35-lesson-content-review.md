...
状态: active
最后更新: 2026-03-30
摘要: 记录 `lesson-content-review` 技能对应的稳定执行流程，覆盖讲义正文技术审查、`interactive-page.md` 与 `interactive-contract.yaml` 双轨互动设计审查、BOPPPS 覆盖检查、知识卡核对、代码直出媒体审核，以及 runtime `review/` 审查包导出。
上游:
...
9. 运行 `python3 course-content/scripts/review_lesson_content.py --lesson <lesson>`，生成 `course-content/runtime/lessons/<lesson>/review/*`
