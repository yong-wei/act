...
状态: active
最后更新: 2026-03-17
摘要: 记录系统如何部署、如何迁移、如何观测，以及线上最常见的真实风险。
上游:
...
- [20-env-and-secrets.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/30-operations/20-env-and-secrets.md)
...
- [60-remote-access-and-hosts.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/30-operations/60-remote-access-and-hosts.md)
相关:
...
- 判断问题更像源码问题还是部署问题
- 排查数据库迁移、缺表、镜像更新、旧资源缓存
- 需要了解生产环境的验证入口和部署脚本行为
