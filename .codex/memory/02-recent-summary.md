...
状态: active
最后更新: 2026-03-20
摘要: 这是智能体初始化时优先读取的最近上下文入口，浓缩最近几次会话中最值得先知道的稳定变化、当前风险与建议下一跳；当前除 `lesson-content-review` 已在 `1-2` 跑通外，`1-2` 本身也已完成 runtime-first 精品互动课落地。
上游:
...
- 精品课程族现在除 `L-2a/L-2b/L-2c/L-2d/L-sum/Cruise comfort` 外，还应包括 `1-1` 与 `1-2`
...
- 若任务与 `1-1`、`1-2`、精品互动课注册、runtime 讲义/媒体导出或页面级 AI 上下文有关，先读 [40-domain/20-premium-courses.md](/Users/YW/Documents/Site/act.just.edu.cn/.codex/memory/40-domain/20-premium-courses.md)
