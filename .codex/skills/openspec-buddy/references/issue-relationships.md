...
```bash
.codex/skills/openspec-buddy/scripts/create-series-parent.sh <series-name> [title]
```
...
```bash
.codex/skills/openspec-buddy/scripts/link-issue-dependencies.sh <issue-A> <issue-B>
```
...
```bash
.codex/skills/openspec-buddy/scripts/list-ready-change-relationships.sh 100
node .codex/skills/openspec-buddy/scripts/verify-issue-relationships.mjs < relationships.json
```
