...
1. **层次切换**：进入新层次时，应设置一句简洁的桥接语，说明上一阶段形成了什么直观认识、当前阶段将把它推进到什么形式化层次——学生需要感知自己从“感性认知”跨越到“形式化证明”，这种跨越需要显式桥接才不会脱节。
2. **承诺兑现**：legacy 速通课中凡出现“暂不展开推导”的内容，都应给出后续完整展开的明确指引——旧速通内容如不给出后续指引，学生会形成错误的概念闭合感，后续课程铺垫失效。
...
5. **图谱定位**：每节开场都应有一句简洁的知识定位语，提示当前内容在课程地图中的位置——开场的知识地图回顾帮助学生激活已有知识网络，降低新知识的孤立感和认知负担。
