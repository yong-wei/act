    ...
    >
      <span className="relative flex h-10 w-[120px] shrink-0 items-center sm:h-12 sm:w-[182px]">
        <Image
          ...
          className={cn(
            'h-full w-full object-contain object-left drop-shadow-[0_10px_22px_rgba(14,165,233,0.24)] transition dark:brightness-125 dark:saturate-125 dark:drop-shadow-[0_12px_28px_rgba(56,189,248,0.42)] group-hover:drop-shadow-[0_12px_28px_rgba(14,165,233,0.32)] dark:group-hover:drop-shadow-[0_14px_34px_rgba(56,189,248,0.5)]',
            imageClassName,
          )}
        />
      </span>
