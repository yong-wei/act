...
export default function PidSimulatorPage() {
  ...
  const [modelKey, setModelKey] = useState<ModelKey>('ship');
  ...
  const modelInfo = useMemo(() => MODEL_CONFIG[modelKey], [modelKey]);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="container mx-auto grid gap-6 px-6 py-6 lg:grid-cols-[320px_1fr]">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/50 p-5">
          ...
          <div className="mt-4 h-[460px] rounded-xl border border-slate-800 bg-slate-950/60 p-3">
