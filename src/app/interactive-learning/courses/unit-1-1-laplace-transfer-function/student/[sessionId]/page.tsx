...
import { UNIT_1_1StudentPage } from '@/features/interactive/unit-1-1-laplace/student-page';

export default async function UNIT_1_1StudentRoute({
  params,
}: {
  params: {
    sessionId: string;
  ...
  if (params.sessionId !== 'demo') {
    ...
    if (role === 'TEACHER' || role === 'ADMIN') {
      redirect(`/interactive-learning/courses/unit-1-1-laplace-transfer-function/teacher/${params.sessionId}`);
    }
  }
