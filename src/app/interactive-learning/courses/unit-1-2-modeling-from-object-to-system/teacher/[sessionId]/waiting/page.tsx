...
export default async function UNIT_1_2TeacherWaitingRoute({ params }: PageProps) {
  ...
  return <TeacherClassroomWaitingRoute routeSegment="unit-1-2-modeling-from-object-to-system" sessionId={sessionId} />;
}
