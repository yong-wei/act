  ...
  if (loading && !status) {
    return (
      <div className="admin-console-shell">
        <div className="admin-console-container flex min-h-screen items-center justify-center">
    ...
    return (
      <div className="admin-console-shell">
        <div className="admin-console-container py-8">
          <Link href="/admin" className="admin-console-back-link mb-6">
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <span className="admin-console-kicker">治理看板</span>
                  <h1 className="admin-console-title text-3xl font-semibold">数据治理</h1>
                  <p className="admin-console-muted max-w-3xl text-sm leading-6">
                    这里不只展示总量，而是直接展开风险、事实与快照的下层内容，帮助管理员判断治理链路到底卡在队列、快照还是风险处置。
                  </p>
                </div>
              </div>
