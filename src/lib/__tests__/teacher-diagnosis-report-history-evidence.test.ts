...
function manifest(): TeacherDiagnosisReportHistoryEvidenceManifest {
  return {
    ...
    captures: [
      ...
      {
        name: 'class-generation-queued-1440-light',
        routePath: '/teacher/classes/class-evidence',
        viewport: { width: 1440, height: 1100 },
        screenshot: 'artifacts/commercial-ui/teacher-diagnosis-report-history-1177/playwright/class-generation-queued-1440-light.png',
        screenshotSha256: SHA_64,
        consoleErrors: 0,
        pageErrors: 0,
        horizontalOverflow: false,
      ...
      {
        name: 'class-generation-completed-1440-light',
        routePath: '/teacher/classes/class-evidence',
        viewport: { width: 1440, height: 1100 },
      ...
      {
        name: 'student-generation-timeout-320-dark',
        routePath: '/teacher/classes/class-evidence/students/student-evidence',
        viewport: { width: 320, height: 844 },
        screenshot: 'artifacts/commercial-ui/teacher-diagnosis-report-history-1177/playwright/student-generation-timeout-320-dark.png',
        screenshotSha256: SHA_64,
        consoleErrors: 0,
        pageErrors: 0,
        horizontalOverflow: false,
      ...
      {
        name: 'student-generation-retry-320-dark',
        routePath: '/teacher/classes/class-evidence/students/student-evidence',
        viewport: { width: 320, height: 844 },
        screenshot: 'artifacts/commercial-ui/teacher-diagnosis-report-history-1177/playwright/student-generation-retry-320-dark.png',
        screenshotSha256: SHA_64,
        consoleErrors: 0,
        pageErrors: 0,
        horizontalOverflow: false,
