...
export const FROZEN_CALLERS: Readonly<Record<string, readonly GraphCaller[]>> = {
  ...
  'eligibility:full-resource-path-readiness-gate': [
    ...
    { path: 'docs/architecture/fitness-budget-ledger.json', symbol: 'src/lib/full-resource-path-readiness-gate.ts', callerClass: 'historical', kind: 'import' },
  ...
  'eligibility:resource-node-aggregate-ready': [
    ...
    { path: 'docs/architecture/fitness-budget-ledger.json', symbol: 'src/lib/resource-node-registry.ts', callerClass: 'historical', kind: 'import' },
  ...
  'knowledge-projection:nodes-list-array-dto': [
    ...
    { path: 'docs/architecture/fitness-budget-ledger.json', symbol: 'src/app/api/knowledge/nodes/route.ts', callerClass: 'historical', kind: 'import' },
