...
export const UNIT_4_1_COURSE_META = {
  ...
  courseDescription:
    '围绕指标角色重组、硬约束/软目标/观察指标分类、可行域分层和双案例联读，把已有分析证据重写成任务表达卡。',
...
export const UNIT_4_1_STEP_AI_CONTEXTS: Record<string, AIContextConfig> = {
  'step-01': context(
    'step-01',
    '课程定位：稳定只是起点，4-1 先写任务书',
    'theory',
    ['明确 4-1 是模块 4 的任务表达入口', '区分稳定分析和设计任务表达'],
    [
      { label: '为什么还不够', question: '为什么系统已经稳定，还不能直接跳到控制器选型？' },
      { label: '4-1 接什么', question: '3-9 的综合映射结果进入 4-1 后，为什么必须改写成任务表达？' },
    ],
    '当前页面只允许解释课程路径和任务表达边界，不展开任何控制器建议。',
  ),
  'step-02': context(
    'step-02',
    '目标与边界：4-1 只负责把任务写清楚',
    'theory',
    ['建立本课四项目标', '守住不越级到 4-2/4-3 的边界'],
    [
      { label: '四项目标', question: '4-1 的四个固定学习目标分别是什么？' },
      { label: '为什么先停在这里', question: '为什么 4-1 必须停在“任务表达”而不是直接开始整定？' },
    ],
    '只解释目标卡和边界表，不替学生生成任何设计方案。',
  ),
  'step-03': context(
    'step-03',
    '前测：先暴露“稳定就够了”等入口误判',
    'quiz',
    ['识别稳定不等于任务完成', '识别“所有指标都重要”不是合格任务书'],
    [
      { label: '为什么稳定不够', question: '为什么“已经稳定”仍然不足以构成一份合格任务书？' },
      { label: '为什么要排序', question: '为什么把所有指标都写上去，反而说明任务还没写清？' },
    ],
    '只做错因归类与术语纠偏，不替学生直接作答。',
  ),
  'step-04': context(
    'step-04',
    '指标角色重组：时域、频域、积分误差分别回答不同问题',
    'practice',
  ...
  'step-07': context(
    ...
    [
      ...
      { label: '证据从哪来', question: '在客船案例里，哪些图上证据共同支撑“边界优先”的判断？' },
    ],
