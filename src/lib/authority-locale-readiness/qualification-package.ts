 ...
 *
 * Publication time: adapt the exact upstream bundle, qualify both locales
 ...
 * Request time: read the package that travels with the admitted Runtime.
 * Identity drift against live pointers is not a refuse gate.
 */
...
/**
 * Package self-check against the registry that travels with the same Runtime.
 * Does not compare live shard pointers or the compiled interface catalog.
 */
