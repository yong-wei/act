...
export const GRAPH_INTERFACE_KEYS = [
  ...
  'search.label',
  'scope.allDomains',
  'scope.domainDirectory',
  'scope.domainOverview',
  'scope.currentRange',
  'scope.neighborhood',
  'scope.returnOverview',
  'search.placeholder',
  'search.empty',
  'search.searching',
  'search.failed',
  ...
  'filter.panel',
  'filter.nodeTypes',
  'filter.nodeResources',
  'filter.anyResourceTypes',
  'filter.resourceType.lesson',
  'filter.resourceType.handout',
  'filter.resourceType.step',
  'filter.resourceType.textbook',
  'filter.resourceType.textbook-chapter',
  'filter.resourceType.textbook-section',
  'filter.resourceType.card',
  'filter.resourceType.infographic',
  'filter.resourceType.video',
  'filter.resourceType.audio',
  'filter.resourceType.podcast',
  'filter.resourceType.slides',
  'filter.resourceType.exercise',
  'filter.resourceType.simulation',
  ...
  'filter.family.prerequisite-order',
...
export const GRAPH_INTERFACE_CATALOG: CatalogTable = {
  ...
  'scope.allDomains': { 'zh-CN': '全部领域', en: 'All domains' },
  'scope.domainDirectory': { 'zh-CN': '领域目录', en: 'Domain directory' },
  'scope.domainOverview': { 'zh-CN': '领域概览', en: 'Domain overview' },
  'scope.currentRange': { 'zh-CN': '当前范围', en: 'Current scope' },
  'scope.neighborhood': { 'zh-CN': '相关知识', en: 'Related knowledge' },
  'scope.returnOverview': { 'zh-CN': '返回领域概览', en: 'Back to domain overview' },
  ...
  'filter.nodeResources': { 'zh-CN': '节点资源', en: 'Node resources' },
  'filter.anyResourceTypes': { 'zh-CN': '不限资源类型', en: 'Any resource type' },
  'filter.resourceType.lesson': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['lesson'], en: 'Lesson' },
  'filter.resourceType.handout': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['handout'], en: 'Handout' },
  'filter.resourceType.step': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['step'], en: 'Lesson step' },
  'filter.resourceType.textbook': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['textbook'], en: 'Textbook' },
  'filter.resourceType.textbook-chapter': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['textbook-chapter'], en: 'Textbook chapter' },
  'filter.resourceType.textbook-section': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['textbook-section'], en: 'Textbook section' },
  'filter.resourceType.card': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['card'], en: 'Knowledge card' },
  'filter.resourceType.infographic': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['infographic'], en: 'Infographic' },
  'filter.resourceType.video': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['video'], en: 'Video' },
  'filter.resourceType.audio': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['audio'], en: 'Audio' },
  'filter.resourceType.podcast': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['podcast'], en: 'Audio' },
  'filter.resourceType.slides': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['slides'], en: 'Slides' },
  'filter.resourceType.exercise': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['exercise'], en: 'Exercise' },
  'filter.resourceType.simulation': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['simulation'], en: 'Simulation' },
  'filter.resourceType.project': { 'zh-CN': PUBLISHED_RESOURCE_LABELS['project'], en: 'Project' },
