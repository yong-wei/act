...
export const PLATFORM_PRIMARY_ROUTE_INVENTORY: PlatformPrimaryRouteInventoryEntry[] = [
  ...
  primaryRoute({
    ...
    owningChange: 'standardize-interactive-classroom-entry',
    contextualReturn: {
      sourceContext: 'interactive-learning',
      targetHint: 'Return to the concrete course entry before opening or starting a classroom.',
      fallbackHref: '/interactive-learning/courses',
    },
  }),
  primaryRoute({
  ...
  primaryRoute({
    href: '/missions/assignments/[assignmentId]',
    routeFile: 'src/app/(main)/missions/assignments/[assignmentId]/page.tsx',
    routePattern: '/missions/assignments/:assignmentId',
    coveredRouteGlob: 'src/app/(main)/missions/assignments/*/page.tsx',
    frame: 'mission-workspace',
    roleScope: ['student'],
    authState: 'protected-redirect',
    navigationLayers: ['global-product', 'contextual-workspace', 'local-tool'],
    ...
    visualQaProfile: 'representative',
    mobileNavigation: 'role-route-tabs',
    owningChange: 'close-teacher-review-student-feedback-loop',
  }),
  primaryRoute({
  ...
  primaryRoute({
    ...
    routeFile: 'src/app/teacher/assignments/[assignmentId]/submissions/page.tsx',
    routePattern: '/teacher/assignments/:assignmentId/submissions',
    coveredRouteGlob: 'src/app/teacher/assignments/*/submissions/page.tsx',
    frame: 'operations-console',
    roleScope: ['teacher', 'admin'],
    authState: 'protected-redirect',
    navigationLayers: ['role-cockpit', 'contextual-workspace', 'local-tool'],
  ...
  primaryRoute({
    href: '/teacher/assignments/[assignmentId]/submissions/[submissionId]/review',
    routeFile: 'src/app/teacher/assignments/[assignmentId]/submissions/[submissionId]/review/page.tsx',
    routePattern: '/teacher/assignments/:assignmentId/submissions/:submissionId/review',
    coveredRouteGlob: 'src/app/teacher/assignments/*/submissions/*/review/page.tsx',
    frame: 'operations-console',
    roleScope: ['teacher', 'admin'],
    authState: 'protected-redirect',
    navigationLayers: ['role-cockpit', 'contextual-workspace', 'local-tool'],
  ...
  primaryRoute({
    ...
    routeFile: 'src/app/teacher/smart-prep/page.tsx',
    frame: 'operations-console',
    roleScope: ['teacher'],
    authState: 'protected-redirect',
    navigationLayers: ['role-cockpit', 'contextual-workspace', 'local-tool'],
...
const PLATFORM_ROLE_NAVIGATION_ITEMS: readonly PlatformRoleNavigationItem[] = [
  ...
  },
  {
    ...
    order: 170,
    group: 'role-cockpit',
    description: '查看能力画像、课堂班级、成长建议和学习记录。',
    iconKey: 'profile',
    actionLabel: '查看画像',
    actionPriority: 80,
    aliasHrefs: ['/profile/growth', '/profile/portfolio', '/profile/evidence'],
  },
  {
