...
export const PLATFORM_BRAND_ASSET_REFERENCES: PlatformBrandAssetReference[] = [
  {
    kind: 'app-mark',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#app-mark',
  ...
  },
  {
    ...
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#horizontal-lockup',
  ...
  {
    kind: 'compact-mark',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#compact-mark',
  ...
  {
    kind: 'favicon',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#favicon',
  ...
  {
    kind: 'route-badge',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#route-badge',
  ...
  {
    kind: 'arena-badge',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#arena-badge',
  ...
  {
    kind: 'course-badge',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#course-badge',
  ...
  },
  {
    ...
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#workbench-chrome',
  ...
  {
    kind: 'data-snapshot',
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#data-snapshot',
  ...
  },
  {
    ...
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#governance-snapshot',
  ...
  },
  {
    ...
    sourcePath: 'public/assets/platform-brand/instrument-atlas-brand-kit.svg#report-watermark',
