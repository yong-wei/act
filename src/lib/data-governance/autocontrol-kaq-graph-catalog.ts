...
const edges: KaqGraphEdge[] = [
  ...
  },
  {
    ...
    relation: 'depends-on',
    strength: 'medium',
    rationale: 'Root-locus design depends on performance targets translated from time-domain requirements.',
  },
  {
  ...
  {
    id: 'edge:kn:correction-assesses-validation',
    domain: 'knowledge',
    sourceNodeId: KNOWLEDGE_NODE_IDS.controllerCorrection,
    targetNodeId: KNOWLEDGE_NODE_IDS.simulationValidation,
    relation: 'assesses',
    strength: 'medium',
  ...
  {
    id: 'edge:cap:synthesis-assesses-validation',
    domain: 'capability',
    sourceNodeId: CAPABILITY_NODE_IDS.synthesis,
