...
function question(): FrozenQuestionContract {
  return {
    ...
    rubric: { schemaVersion: 'rubric.v1', id: 'rubric-1', version: 'rubric.v1', maxScore: 1, criteria: [{ id: 'criterion-1', label: 'Evidence', maxPoints: 1, evidenceDescription: 'evidence', feedbackGuidance: 'cite', levels: [{ id: 'full', label: 'Full', minPoints: 1, maxPoints: 1, description: 'full' }] }] },
  };
}
