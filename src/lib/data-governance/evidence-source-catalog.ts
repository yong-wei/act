...
const CATALOG: EvidenceSourceCatalogEntry[] = [
  ...
  },
  {
    ...
    provenancePolicy: 'Evaluation runs lack user ownership; user attribution comes through a linked ArenaSubmission. Keep unsupported until submission-to-evaluation linking is materialized.',
  },
  {
    id: 'LearningFact',
