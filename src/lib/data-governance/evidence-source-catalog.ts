...
const CATALOG: EvidenceSourceCatalogEntry[] = [
  ...
  },
  {
    ...
    description: 'Learner-owned prompt-evaluation process records for reflection and audit.',
    ...
    provenancePolicy: 'Authenticated prompt evaluations remain process context until source-specific profile governance is approved.',
  },
  {
    id: 'DesignSession',
