        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="premium-lesson-kicker truncate text-[10px] tracking-[0.24em]">{UNIT_1_2_COURSE_SUBTITLE}</div>
              <h1 className="premium-lesson-title truncate text-sm font-semibold md:text-base">{UNIT_1_2_COURSE_TITLE}</h1>
            </div>
          </div>
