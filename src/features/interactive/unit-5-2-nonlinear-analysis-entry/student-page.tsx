...
export function UNIT_5_2StudentPage({
  ...
  if (loadingSession) {
    return (
      <LessonRuntimeLoadingShell
        ...
        subtitle={UNIT_5_2_COURSE_SUBTITLE}
  ...
  return (
    <LessonRuntimeShell
        ...
        steps={UNIT_5_2_LESSON_STEPS}
        activeIndex={activeIndex}
        stageLabel={UNIT_5_2_STAGE_LABEL}
        ...
        runtimeAttributes={{
          ...
          'data-return-target': `/interactive-learning/courses/${UNIT_5_2_ROUTE_SEGMENT}`,
          'data-runtime-manifest-truth': lessonRuntime.interactiveManifest?.lessonId ?? UNIT_5_2_LESSON_KEY,
