...
export function UNIT_1_5CourseEntryPage({
  initialRole,
  lessonRuntime,
}: {
  ...
  return (
    <CourseEntryShell
      ...
      config={{
        ...
        description: UNIT_1_5_COURSE_DESCRIPTION,
        presetKey: UNIT_1_5_PRESET_KEY,
        routeSegment: UNIT_1_5_ROUTE_SEGMENT,
        overviewKicker: `${lessonRuntime.lesson.lesson_id} · 三域增益扫描主线课程`,
