...
export function CruiseStandardCourseHeader({
  steps,
  activeIndex,
  onIndexChange,
  middleNotice,
  ...
  steps: readonly CruiseStandardLessonStep[];
  activeIndex: number;
      ...
      <div className="w-full px-3 py-2 sm:px-4 sm:py-2.5">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            <Link href={`/interactive-learning/courses/${CRUISE_ROUTE_SEGMENT}`} className="premium-lesson-nav-button shrink-0">
              返回
            </Link>
          ...
          <div className="ml-auto flex shrink-0 flex-col items-end gap-1">
            ...
            <label className="premium-lesson-control inline-flex items-center gap-2">
              <span>环节</span>
              <select
                id="cruise-standard-step-select"
                name="lessonStep"
                aria-label="选择课程环节"
