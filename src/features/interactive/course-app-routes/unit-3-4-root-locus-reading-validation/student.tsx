...
export default async function UNIT_3_4StudentRoute(
  ...
  await redirectInactiveStudentSessionToLessonEntry(params.sessionId, '/interactive-learning/courses/unit-3-4-root-locus-reading-validation');
