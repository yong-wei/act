...
import {
  ...
  L2B_STAGE_LABEL,
  L2B_STEP_DURATION,
  type L2BStepDefinition,
} from '@/lib/l2b-course';

export function L2BCourseHeader({
  steps,
  activeIndex,
  onIndexChange,
  middleNotice,
      ...
      <div className="mx-auto max-w-[1280px] px-3 py-2 sm:px-4 sm:py-2.5">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            <Link href={`/interactive-learning/courses/${L2B_ROUTE_SEGMENT}`} className="premium-lesson-nav-button shrink-0">
              返回
            </Link>
