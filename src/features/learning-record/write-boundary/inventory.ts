...
export const WRITE_BOUNDARY_ROWS: readonly WriteBoundaryRow[] = [
  ...
  row('producer.arena.official', 'arena-official-writeback', 'src/features/arena/evidence-writeback-persistence.ts', 'arena', 'direct', 'writeKnowledgeScopedLearningFacts', 'arena-official: prefix', 'official submission identity', 'server evaluation time', 'teacher-scoped', 'arena writeback only', 'arena ranking/evidence', 'arena-evidence-writeback-persistence.test.ts', 'migrated to arena evidence-writeback', 'canonical'),
  row('producer.teacher.document-rubric', 'document-rubric', 'src/features/teacher/document-rubric-grading-workbench.ts', 'teacher', 'direct', 'writeKnowledgeScopedLearningFacts', 'grading: prefix', 'document grading identity', 'teacher approved time', 'teacher-scoped', 'none in this change', 'teacher grading', 'document-rubric-grading-workbench.test.ts', 'migrated to teacher document-rubric workbench', 'canonical'),
  row('producer.teacher.document-approve', 'document-grading-approve', 'src/app/api/teacher/document-grading/approve/route.ts', 'teacher', 'direct', 'writeKnowledgeScopedLearningFacts', 'adaptive-assessment:document-rubric-grading', 'approve route identity', 'server approve time', 'teacher-scoped', 'none in this change', 'teacher grading', 'document-rubric-grading-routes.test.ts', 'teacher approve route uses domain owner', 'canonical'),
