...
describe('knowledge graph interaction state stability', () => {
  ...
  it('keeps hover and selection out of graph filtering, membership, and layout derivation', () => {
    ...
    expect(rendererSource).toContain('}, [nodes, links, relayoutVersion, expandedNodeIds, expandedDirectLinks]);');
    ...
    expect(canvasSource).toContain('}, [nodes, links, relayoutVersion, expandedNodeIds, expandedDirectLinks]);');
