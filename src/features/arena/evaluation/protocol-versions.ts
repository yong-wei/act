// Server-side ControlAnalysisResult-backed evaluation for supported white-box methods.
...
export const BLACKBOX_OFFICIAL_PROTOCOL_VERSION = 'blackbox-official-v1';
