...
export const LESSON_13_PHASE_STABILITY_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: '开环幅相特性曲线_5_fd86e289',
      duration: 2,
      title: '知识卡片：开环幅相特性定义',
    ...
    },
    {
      ...
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '奈奎斯特曲线_5_deaa0845',
      duration: 2,
      title: '知识卡片：起点与终点',
    ...
    },
    {
      ...
      order: 3,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '穿越频率_5_c4c2b93c',
      duration: 2,
    ...
    },
    {
      ...
      order: 7,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '幅角原理_5_f843970e',
      duration: 2,
      title: '知识卡片：幅角原理',
    ...
    },
    {
      ...
      order: 8,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '奈奎斯特稳定判据_5_a1b34560',
      duration: 2,
      title: '知识卡片：奈奎斯特稳定判据',
    ...
    },
    {
      ...
      order: 9,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '对数稳定判据_5_50391b50',
      duration: 2,
      title: '知识卡片：对数稳定判据',
