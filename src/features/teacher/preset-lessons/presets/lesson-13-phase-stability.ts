...
export const LESSON_13_PHASE_STABILITY_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: 'node-nyquist-definition',
      duration: 2,
      title: '知识卡片：开环幅相特性定义',
      description: '明确 Nyquist 图的定义与频率响应关系。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-nyquist-start-end',
      duration: 2,
      title: '知识卡片：起点与终点',
      description: '确定低频起点与高频终点的物理含义。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 3,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-nyquist-crossing',
      duration: 2,
      title: '知识卡片：负实轴交点与穿越频率',
      description: '连接相位穿越与幅值穿越的几何意义。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 4,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-nyquist-feature-points',
      duration: 2,
      title: '知识卡片：特征点求法',
      description: '用实部/虚部分析锁定关键交点。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 5,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-nyquist-sketch-steps',
      duration: 2,
      title: '知识卡片：概略绘制步骤',
      description: '三步完成幅相曲线的概略绘制。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 6,
    ...
    },
    {
      ...
      order: 7,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-argument-principle',
      duration: 2,
      title: '知识卡片：幅角原理',
      description: '理解 Z、P、N 之间的来源关系。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 8,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-nyquist-criterion',
      duration: 2,
      title: '知识卡片：奈奎斯特稳定判据',
      description: '用包围次数判断闭环极点分布。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 9,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-log-stability-criterion',
      duration: 2,
      title: '知识卡片：对数稳定判据',
      description: '将 Nyquist 判据映射到 Bode 图穿越关系。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 10,
