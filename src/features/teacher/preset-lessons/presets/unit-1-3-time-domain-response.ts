...
import { UNIT_1_3_COURSE_TITLE, UNIT_1_3_LESSON_STEPS, UNIT_1_3_PRESET_KEY, UNIT_1_3_STAGE_MAP } from '@/lib/unit-1-3-course';

export const UNIT_1_3_TIME_DOMAIN_RESPONSE_PRESET: PresetLessonConfig = {
