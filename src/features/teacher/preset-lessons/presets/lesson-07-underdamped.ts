...
export const LESSON_07_UNDERDAMPED_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    },
    {
      ...
      knowledgeNodeId: '二阶系统标准型_3_L2a',
      duration: 2,
      title: '知识卡片：二阶系统标准型与分类',
      description: '明确欠阻尼、临界阻尼与过阻尼的判据。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 2,
    ...
    },
    {
      ...
      duration: 3,
      title: '知识卡片：标准二阶系统参数',
      description: '掌握阻尼比 ζ 与自然频率 ω_n 的含义。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 4,
    ...
    },
    {
      ...
      duration: 2,
      title: '知识卡片：阶跃响应指标',
      description: '用超调量、峰值时间与调节时间描述响应。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 7,
    ...
    },
    {
      ...
      duration: 3,
      title: '知识卡片：阻尼比与自然频率权衡',
      description: '理解响应速度与振荡幅值的平衡。',
    },
    {
      stage: 'PARTICIPATORY',
      order: 9,
