...
export const LESSON_03_DIFFERENTIAL_MODELING_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: '微分方程_2_775c96a3',
      duration: 1,
      title: '知识卡片：微分方程模型',
    ...
    },
    {
      ...
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '分析法_2_bc08248e',
      duration: 1,
      title: '知识卡片：机理建模方法',
    ...
    },
    {
      ...
      order: 3,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '实验法_系统辨识__2_b07364ee',
      duration: 1,
      title: '知识卡片：黑箱建模',
    ...
    },
    {
      ...
      order: 4,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '系统模型转换_1_18f4b178',
      duration: 1,
      title: '知识卡片：模型类型',
    ...
    },
    {
      ...
      order: 6,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '数学模型_2_b21e01f6',
      duration: 1,
      title: '知识卡片：典型案例',
    ...
    },
    {
      ...
      order: 7,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '非线性微分方程的线性化_2_caa86ba6',
      duration: 1,
      title: '知识卡片：非线性线性化',
