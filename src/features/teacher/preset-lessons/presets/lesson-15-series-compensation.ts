...
export const LESSON_15_SERIES_COMPENSATION_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: 'node-series-compensation',
      duration: 1,
      title: '知识卡片：串联校正',
    ...
    },
    {
      ...
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lead-network-feature',
      duration: 1,
      title: '知识卡片：超前网络特性',
    ...
    },
    {
      ...
      order: 3,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lead-max-phase',
      duration: 1,
      title: '知识卡片：最大超前角',
    ...
    },
    {
      ...
      order: 4,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lead-design-steps',
      duration: 1,
      title: '知识卡片：超前设计步骤',
    ...
    },
    {
      ...
      order: 5,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lag-network-feature',
      duration: 1,
      title: '知识卡片：滞后网络特性',
    ...
    },
    {
      ...
      order: 6,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lag-design-steps',
      duration: 1,
      title: '知识卡片：滞后设计步骤',
    ...
    },
    {
      ...
      order: 7,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lag-lead-compensation',
      duration: 1,
      title: '知识卡片：滞后-超前联合',
    ...
    },
    {
      ...
      order: 8,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-lag-lead-workflow',
      duration: 1,
      title: '知识卡片：联合设计流程',
