...
export const LESSON_14_STABILITY_MARGIN_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: 'node-stability-margin-definition',
      duration: 1,
      title: '知识卡片：稳定裕度定义',
    ...
    },
    {
      ...
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-phase-margin',
      duration: 1,
      title: '知识卡片：相角裕度',
    ...
    },
    {
      ...
      order: 3,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-gain-margin',
      duration: 1,
      title: '知识卡片：幅值裕度',
    ...
    },
    {
      ...
      order: 4,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-margin-bode-estimation',
      duration: 1,
    ...
    },
    {
      ...
      order: 5,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-three-band-theory',
      duration: 1,
      title: '知识卡片：三频段理论',
    ...
    },
    {
      ...
      order: 6,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-low-frequency-band',
      duration: 1,
      title: '知识卡片：低频段与稳态误差',
    ...
    },
    {
      ...
      order: 7,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-mid-frequency-band',
      duration: 1,
      title: '知识卡片：中频段与动态性能',
    ...
    },
    {
      ...
      order: 8,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'node-high-frequency-band',
      duration: 1,
