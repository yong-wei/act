...
export const LESSON_04_TRANSFER_FUNCTION_PRESET: PresetLessonConfig = {
  ...
  items: [
    ...
    // ==================== Stage 4: Participatory (参与式学习) - 50分钟 ====================
    {
      ...
      knowledgeNodeId: '传递函数_2_2c5e2589',
      duration: 1,
      title: '知识卡片：传递函数定义',
    ...
    },
    {
      ...
      order: 2,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '零初始条件响应_2_fce2116f',
      duration: 1,
      title: '知识卡片：零初始条件',
    ...
    },
    {
      ...
      order: 4,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '传递函数标准形式_2_11003',
      duration: 1,
      title: '知识卡片：零极点形式',
    ...
    },
    {
      ...
      order: 5,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: '闭环特征方程_3_87c88e19',
      duration: 1,
      title: '知识卡片：特征多项式',
    ...
    },
    {
      ...
      order: 10,
      itemType: 'KNOWLEDGE_NODE',
      knowledgeNodeId: 'MATLAB控制系统工具箱_1_e058c580',
      duration: 1,
