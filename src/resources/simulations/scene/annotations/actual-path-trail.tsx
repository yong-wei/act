...
/** 实际航迹线：默认常驻的教学锚点（积分语义可视化），样式与写实场景协调。 */
export function ActualPathTrail({ positionSampler, resetToken, y = 0.7 }: ActualPathTrailProps) {
  ...
  useFrame((state) => {
    ...
    setPoints((previous) => appendTrailPoint(previous, new THREE.Vector3(position.x, y, position.z)));
  });
