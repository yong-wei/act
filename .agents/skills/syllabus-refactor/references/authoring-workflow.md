...
按当前层级选择相关真源，已有未变上下文可复用；整课重构才需要联合阅读以下材料：
...
用户已授权的修订可直接回写；未决定的方案标明待选或草案，不写成已接受决策。重要教学取舍需要明确接受。
...
- 课程质量透镜：`course-quality-lens.md`
- 源文件与使用时机：`source-map.md`
