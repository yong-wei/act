...
\renewcommand{\thefigure}{1-5-\arabic{figure}}
\renewcommand{\thetable}{1-5-\arabic{table}}
\renewcommand{\theequation}{1-5-\arabic{equation}}
...
\hypersetup{
  ...
  citecolor=TitleBlue,
  pdftitle={单元 1-5 | 三域联动：一个增益如何改变稳定性}
}
