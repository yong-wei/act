...
### 资源 intro-video | 课程导入视频
- **原料**：`media/raw/2-2-intro-video-prompt.md`
- **成品**：`media/processed/2-2-intro-video.mp4`（已完成）
- **引用位置**：课堂开场 / `interactive-page.md` 首页导入区域
- **用途**：用闲聊自控导入片建立“稳定了为什么还不够”的问题情境。
- **备注**：当前成品是 Remotion 课程导入片，不再使用 15 秒即梦短片作为正式交付。
...
- **公式模式**：`svg-mathtext`
- **页面公式来源**：`design/2-2-handout.md`, `design/2-2-interactive-page.md`
