...
| 68-82 min | 两道例题 | 一题顺推，一题逆推 | 完成参数识别与约束判断 | 顺推示例图、逆推极点区域图；板书 5 |
...
![由性能指标反推极点区域](../media/processed/td-06-time-spec-to-pole-region.svg)

用途：例题二结尾使用，强调本节不是停留在曲线，而是迈向参数约束与设计区域。
