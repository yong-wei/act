...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Generate 2-2 td-02 first-order step response SVG.')
    parser.add_argument(
        '--output',
        type=Path,
        default=Path(__file__).resolve().parent.parent / 'processed' / '2-2-td-02-first-order-step-time-constant.svg',
    )
