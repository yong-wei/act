...
![时域分析典型输入与响应对象示意图（待制作）](../media/processed/td-01-time-domain-input-response-overview.svg)
...
![一阶系统单位阶跃响应与时间常数示意图（待制作）](../media/processed/td-02-first-order-step-time-constant.svg)
...
![二阶系统四种典型响应形态对比图（待制作）](../media/processed/td-03-second-order-response-families.svg)
...
![动态性能指标标注示意图（待制作）](../media/processed/td-04-time-domain-indices-annotated.svg)
...
![例题一响应曲线与性能指标示意图（待制作）](../media/processed/td-05-example-response-with-indices.svg)
...
![由时域指标反推极点约束区域示意图（待制作）](../media/processed/td-06-time-spec-to-pole-region.svg)
