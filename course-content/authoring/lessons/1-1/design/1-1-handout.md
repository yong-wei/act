...
![基本控制系统结构要素，包含比较点、决策环节、执行器、对象和传感器五个环节，箭头标注信号流动方向](../media/processed/1-1-block-diagram-basic.png){width=85%}
...
![一阶对象根轨迹图，显示增益增大时极点从对象极点出发并沿实轴向左移动](../media/processed/1-1-root-locus-example.png){width=80%}
