...
\begin{tikzpicture}[>=Stealth]
  ...
  \newcommand{\drawrow}[4]{
    ...
    \node[block] (c#1) at (5.45,#2) {控制器};
    \node[wideblock] (a#1) at (8.05,#2) {执行机构};
    \node[wideblock] (p#1) at (10.75,#2) {对象输出};
    \node[tap] (tap#1) at (12.25,#2) {};
    \node[labeltext] (out#1) at (13.20,#2) {$y$};
    \node[wideblock] (m#1) at (8.05,#2-1.36) {#4};
    ...
    \node[plotbox] (pc#1) at (5.45,#2+0.68) {};
    \node[plotbox] (pa#1) at (8.05,#2+0.68) {};
    \node[plotbox] (py#1) at (10.75,#2+0.68) {};
    \node[plotbox, minimum width=2.05cm] (pm#1) at (8.05,#2-2.08) {};
  }
