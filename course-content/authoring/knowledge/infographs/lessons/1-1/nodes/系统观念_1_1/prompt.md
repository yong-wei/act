...
一句话定义：
系统观念是在目标、输出、测量、反馈、执行和对象之间同时建立关系的思维方式。

核心直觉：
方法可以变化，但被分析和设计的对象始终是同一个系统。

可用公式（内部依据，图面公式区标题只能写“公式”）：
无公式，图中只放与主题直接相关的短符号。

本课关系：
- 课程总图 --embodies--> 系统观念: 课程总图是系统观念的课程化表达

建议视觉骨架：
用目标、输出、测量、反馈、执行、对象六个关系节点围成系统图，表达同一系统的多角度阅读。
...
- 文字范围：只允许围绕这些标签组织图面文字：系统观念、系统观念、三域联动；全图最多 12 个可见标签；不放正文段落。
...
- 只使用少量短中文标签，优先使用这些词：系统观念、系统观念、三域联动。
