...
一句话定义：
稳定性描述系统受扰后是否能回到可接受状态。

核心直觉：
对线性系统而言，全部极点在左半平面通常意味着响应会衰减并保持稳定。
...
建议视觉骨架：
用 s 平面左半平面/右半平面边界和响应衰减/发散对照表达极点位置如何判断稳定性。
...
- 文字范围：只允许围绕这些标签组织图面文字：稳定性、稳定性、极点；全图最多 12 个可见标签；不放正文段落。
