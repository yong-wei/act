...
一句话定义：
控制器是根据目标与测量结果作出决策、产生控制信号的环节。

核心直觉：
控制器把误差信息转化为执行动作，是设计者最主要的改造对象。
...
建议视觉骨架：
用控制器方框接收误差信号并输出控制量的结构图表达“根据目标与测量结果作出决策”。
...
- 文字范围：只允许围绕这些标签组织图面文字：控制器、控制器；全图最多 12 个可见标签；不放正文段落。
