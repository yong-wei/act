...
所属分组：入口回收与指标重组、主场景联读、对照案例与排序重排
知识类型：C
...
text_contract: 只允许围绕这些标签组织图面文字：带宽频率、3dB点、闭环幅频特性、闭环频率特性、响应速度、截止频率、层1精化、频域分析、2-4；全图最多 12 个可见标签；不放正文段落。
...
- 只使用少量短中文标签，优先使用这些词：带宽频率、3dB点、闭环幅频特性、闭环频率特性、响应速度、截止频率、层1精化、频域分析、2-4。
