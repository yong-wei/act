...
## Subject
- Title: The frequency of undamped (modeling_8d3c115cdb81c364733e1e43)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The frequency of undamped：The frequency of undamped natural oscillation for a linearized pendulum, given by ω_n = sqrt(g/l).
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The frequency of undamped natural oscillation for a linearized pendulum, given by ω_n = sqrt(g/l).
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The frequen…」
