...
- One-line definition (source of truth): 由于 PD 控制相当于给系统增加了一个闭环零点，-z=-1/T_d，故比例-微分控制的二阶系统称为有零点的二阶系统。
- Core intuition: 在图谱邻接中可把握：后续 → 二阶系统。
- Relation summary: 后续 → 二阶系统
- Extended explanation (do not paste verbatim on image): 由于 PD 控制相当于给系统增加了一个闭环零点，-z=-1/T_d，故比例-微分控制的二阶系统称为有零点的二阶系统。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「有零点的二阶系统」、「是一种·二阶系统」
