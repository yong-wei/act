...
## Subject
- Title: 离散化状态方程的解 (modeling_c7e02ad3e9eb1c529a54d16a)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 离散化状态方程的解，又称离散化状态转移方程。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 离散化状态方程的解，又称离散化状态转移方程。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「离散化状态方程的解」
