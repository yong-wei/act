...
## Subject
- Title: Lyapunov's indirect method
- Concept kind: unknown
- One-line definition (source of truth): Lyapunov's indirect method是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Lyapunov's …」
