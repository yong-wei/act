...
## Subject
- Title: type of ideal element (modeling_47a00ebb2fb5027988fd918d)
- Concept kind: theoretical_construct
- One-line definition (source of truth): type of ideal element：A type of ideal element that stores energy in an inductive form, including electrical inductance, translational spring,…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A type of ideal element that stores energy in an inductive form, including electrical inductance, t…
