...
## Subject
- Title: function that is for (modeling_a4b27ffcac4ec72c414a553b)
- Concept kind: theoretical_construct
- One-line definition (source of truth): function that is for：A function that is 0 for t<0 and 1 for t≥0.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A function that is 0 for t<0 and 1 for t≥0.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「function th…」
