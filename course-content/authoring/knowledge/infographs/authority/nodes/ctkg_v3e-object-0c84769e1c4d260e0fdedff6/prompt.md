...
## Subject
- Title: Attenuation factor 1/α in compensator
- Concept kind: unknown
- One-line definition (source of truth): Attenuation factor 1/α in compensator：The gain K of the compensator is raised to account for the attenuation (1/α).
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The gain K of the compensator is raised to account for the attenuation (1/α).
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Attenuation…」
