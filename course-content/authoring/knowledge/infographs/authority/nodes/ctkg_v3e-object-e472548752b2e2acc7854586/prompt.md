...
## Subject
- Title: Resonant magnitude
- Concept kind: unknown
- One-line definition (source of truth): Resonant magnitude：The maximum value of the frequency response attained at the resonant frequency.
- Core intuition: 在图谱邻接中可把握：前置 → 阻尼比、Resonant frequency · 后续 → Resonant frequency。
- Relation summary: 前置 → 阻尼比、Resonant frequency · 后续 → Resonant frequency
- Extended explanation (do not paste verbatim on image): The maximum value of the frequency response attained at the resonant frequency.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Resonant ma…」、「Resonant mag」、「关联·阻尼比」、「关联·Resona…」
