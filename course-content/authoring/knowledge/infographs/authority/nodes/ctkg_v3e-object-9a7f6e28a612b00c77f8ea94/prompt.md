...
## Subject
- Title: Phase-lead design using the root locus
- Concept kind: unknown
- One-line definition (source of truth): Phase-lead design using the root locus：The design of the phase-lead compensator using the root locus method. The locations of the compensator zero and pole ar…
...
- Extended explanation (do not paste verbatim on image): The design of the phase-lead compensator using the root locus method. The locations of the compensa…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Phase-lead …」、「应用于·Phase…」
