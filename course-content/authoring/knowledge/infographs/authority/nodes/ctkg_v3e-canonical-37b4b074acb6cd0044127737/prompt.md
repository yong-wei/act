...
## Subject
- Title: Cover-up method
- Concept kind: theoretical_construct
- One-line definition (source of truth): Cover-up method：Cover-up method
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Cover-up method
- Extended explanation (do not paste verbatim on image): Cover-up method
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Cover-up me…」、「Cover-up met」、「一种·Cover-…」
