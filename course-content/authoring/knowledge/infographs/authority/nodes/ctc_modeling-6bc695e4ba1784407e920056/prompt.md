...
## Subject
- Title: The time constant of (modeling_6bc695e4ba1784407e920056)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The time constant of：The time constant of the op-amp integrator, defined as the product of the input resistance and the feedback capacitance…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The time constant of the op-amp integrator, defined as the product of the input resistance and the…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The time co…」
