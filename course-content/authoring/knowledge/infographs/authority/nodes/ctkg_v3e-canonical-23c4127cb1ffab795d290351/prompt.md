...
## Subject
- Title: Modes of the system
- Concept kind: theoretical_construct
- One-line definition (source of truth): Modes of the system：Modes of the system
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → 传递函数
- Extended explanation (do not paste verbatim on image): Modes of the system
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Modes of th…」、「Modes of the」、「派生自·传递函数」
