...
- One-line definition (source of truth): 由跟踪误差和中间变量构成的扩展状态空间系统，用于内模控制器设计。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 增广系统可控性
- Extended explanation (do not paste verbatim on image): 由跟踪误差和中间变量构成的扩展状态空间系统，用于内模控制器设计。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「增广系统」、「应用于·增广系统可…」
