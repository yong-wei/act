...
- One-line definition (source of truth): 非周期信号的频谱特性，频谱为连续分布。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 非周期信号的频谱特性，频谱为连续分布
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「连续谱」
