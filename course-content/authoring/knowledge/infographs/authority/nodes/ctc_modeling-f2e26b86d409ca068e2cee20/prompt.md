...
## Subject
- Title: Time constant of the (modeling_f2e26b86d409ca068e2cee20)
- Concept kind: theoretical_construct
- One-line definition (source of truth): Time constant of the：Time constant of the mechanical load in a DC motor, defined as tau_L = J / b.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): Time constant of the mechanical load in a DC motor, defined as tau_L = J / b.
