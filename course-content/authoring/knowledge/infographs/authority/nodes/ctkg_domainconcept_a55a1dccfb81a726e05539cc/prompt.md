...
## Subject
- Title: G c(s)-to-D(z) conversion method (G_c(s)-to-D(z) conversion method)
- Concept kind: unknown
- One-line definition (source of truth): G c(s)-to-D(z) conversion method是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「G c(s)-to-D…」
