...
- One-line definition (source of truth): Band center：Band center
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → Undamped natural frequency omega n
- Extended explanation (do not paste verbatim on image): Band center
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Band center」、「一种·Undamp…」
