...
- One-line definition (source of truth): Decibel (dB)：A unit of power gain, defined as 1/10 of a bel, used in Bode plots to express magnitude ratios on a logarithmic scale.
- Core intuition: 在图谱邻接中可把握：后续 → Bel、Decibel。
- Relation summary: 后续 → Bel、Decibel
- Extended explanation (do not paste verbatim on image): A unit of power gain, defined as 1/10 of a bel, used in Bode plots to express magnitude ratios on a…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Decibel (dB)」、「属于·Bel」、「派生自·Bel」、「关联·Decibel」、「关联·Bel」
