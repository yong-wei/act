...
## Subject
- Title: mathematical tool used to (modeling_9ba52fe3ff16aed315b747c8)
- Concept kind: analysis_method
- One-line definition (source of truth): mathematical tool used to：A mathematical tool used to simplify the solution of linearized differential equations.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A mathematical tool used to simplify the solution of linearized differential equations.
