...
## Subject
- Title: Continuous syste (Continuous system model of a sampled system)
- Concept kind: unknown
- One-line definition (source of truth): Continuous syste是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Continuous …」
