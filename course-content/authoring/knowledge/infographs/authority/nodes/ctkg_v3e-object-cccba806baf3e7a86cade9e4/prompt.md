...
## Subject
- Title: Right half-plane roots
- Concept kind: unknown
- One-line definition (source of truth): Right half-plane roots：Right half-plane roots
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): Right half-plane roots
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Right half-…」、「Right half-p」
