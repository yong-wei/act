...
## Subject
- Title: 根轨迹 (Root locus)
- Concept kind: unknown
- One-line definition (source of truth): 根轨迹：Root locus。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 根轨迹法、Compensator · 后续 → Integration compensator、Phase-lead compensator
- Extended explanation (do not paste verbatim on image): Root locus
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「根轨迹」、「Root locus」、「用于分析·Inte…」、「用于分析·Phas…」、「应用于·根轨迹法」、「关联·根轨迹法」、「关联·Compen…」
