...
## Subject
- Title: 单容水槽增益K=Ku R (modeling_a650a5ff9a3147b7d49b45b0)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 单容水槽增益K=Ku R，其中Ku为阀门流量系数，R为液阻。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 单容水槽增益K=Ku R，其中Ku为阀门流量系数，R为液阻。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「单容水槽增益K=Ku R」
