...
## Subject
- Title: 系数矩阵元素随时间变化的线性系统 (modeling_20f3dc8367288f2a5908a82b)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 系数矩阵元素随时间变化的线性系统。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 系数矩阵元素随时间变化的线性系统。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「系数矩阵元素随时间变化…」
