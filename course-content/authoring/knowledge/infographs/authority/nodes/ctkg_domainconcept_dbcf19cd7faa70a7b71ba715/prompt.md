...
- One-line definition (source of truth): Lyapunov's direct method是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Lyapunov's …」、「Lyapunov's d」
