...
## Subject
- Title: Closed-loop samp (Closed-loop sampled system with digital computer compensation)
- Concept kind: unknown
- One-line definition (source of truth): Closed-loop samp是自动控制原理权威图谱中的领域概念。
