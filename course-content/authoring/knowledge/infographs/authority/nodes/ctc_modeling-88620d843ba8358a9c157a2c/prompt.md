...
## Subject
- Title: 领域概念 (modeling_88620d843ba8358a9c157a2c)
- Concept kind: analysis_method
- One-line definition (source of truth): 领域概念：A five-step method using Newton's laws to write equations of motion for a rigid body.。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A five-step method using Newton's laws to write equations of motion for a rigid body.
