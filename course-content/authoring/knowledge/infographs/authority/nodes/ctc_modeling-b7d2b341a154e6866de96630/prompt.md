...
## Subject
- Title: 领域概念 (modeling_b7d2b341a154e6866de96630)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 领域概念：The current through a capacitor is proportional to the rate of change of voltage across it, i = C dv/dt.。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The current through a capacitor is proportional to the rate of change of voltage across it, i = C d…
