...
- One-line definition (source of truth): 闭环极点。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 非主导极点、闭环主导极点
- Extended explanation (do not paste verbatim on image): 闭环极点
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「闭环极点」、「是一种·非主导极点」、「是一种·闭环主导极点」
