...
## Subject
- Title: Mixed Continuous-Discrete System
- Concept kind: unknown
- One-line definition (source of truth): Mixed Continuous-Discrete System是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Mixed Conti…」
