...
## Subject
- Title: 系统状态在状态空间中随时间变化… (modeling_f1fa95c18225ac436316bb71)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 系统状态在状态空间中随时间变化的轨迹。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 系统状态在状态空间中随时间变化的轨迹。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「系统状态在状态空间中随…」
