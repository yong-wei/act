...
## Subject
- Title: zeros of l s (zeros_of_l_s)
- Concept kind: mathematical_object
- One-line definition (source of truth): zeros of l s：The roots of b(s)=0, labeled z_i.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → 零点
- Extended explanation (do not paste verbatim on image): The roots of b(s)=0, labeled z_i.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「zeros of l s」、「是一种·零点」
