...
- One-line definition (source of truth): Continuous signal：Continuous signal
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Digital-to-analog converter · 后续 → Discrete signal
- Extended explanation (do not paste verbatim on image): Continuous signal
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Continuous …」、「Continuous s」、「关联·Digita…」、「关联·Discre…」
