...
## Subject
- Title: 阀门流量系数Ku (modeling_56a9fb0159828d74278483da)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 阀门流量系数Ku，表示调节阀开度变化Δu与流入量增量ΔQi的关系：ΔQi=Ku Δu。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 阀门流量系数Ku，表示调节阀开度变化Δu与流入量增量ΔQi的关系：ΔQi=Ku Δu。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「阀门流量系数Ku」
