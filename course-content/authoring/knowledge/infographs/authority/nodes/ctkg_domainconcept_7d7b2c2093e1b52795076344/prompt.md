...
## Subject
- Title: Curves of consta (Curves of constant damping ratio in z-plane (Figure 13.27))
- Concept kind: unknown
- One-line definition (source of truth): Curves of consta是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Curves of c…」
