...
## Subject
- Title: Time constant of the (modeling_88b31a8b95da7d5a6fbcabbf)
- Concept kind: theoretical_construct
- One-line definition (source of truth): Time constant of the：Time constant of the field circuit in a DC motor, defined as tau_f = L_f / R_f.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): Time constant of the field circuit in a DC motor, defined as tau_f = L_f / R_f.
