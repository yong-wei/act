...
## Subject
- Title: The voltage across resistor (modeling_9c45067d35487ce7a3ce6871)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The voltage across resistor：The voltage across a resistor is proportional to the current through it, v = Ri.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The voltage across a resistor is proportional to the current through it, v = Ri.
