...
- One-line definition (source of truth): 对于无源超前网络，T=R1R2C/(R1+R2)；对于无源滞后网络，T=(R1+R2)C。
- Core intuition: 对于无源滞后网络，T=(R1+R2)C。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 对于无源超前网络，T=R1R2C/(R1+R2)；对于无源滞后网络，T=(R1+R2)C。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「时间常数」
