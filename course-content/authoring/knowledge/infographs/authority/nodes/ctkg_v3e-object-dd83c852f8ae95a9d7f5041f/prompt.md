...
## Subject
- Title: Aizermann's conjecture
- Concept kind: unknown
- One-line definition (source of truth): Aizermann's conjecture：Aizermann's conjecture
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Lur'e problem · 后续 → Lur'e problem
- Extended explanation (do not paste verbatim on image): Aizermann's conjecture
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Aizermann's…」、「Aizermann's 」、「应用于·Lur'e…」、「关联·Lur'e …」
