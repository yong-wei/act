...
## Subject
- Title: 求解离散动态方程的一种方法 (modeling_5f0178db5e9334312de23135)
- Concept kind: analysis_method
- One-line definition (source of truth): 求解离散动态方程的一种方法，此处仅提及但未展开。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 求解离散动态方程的一种方法，此处仅提及但未展开。
