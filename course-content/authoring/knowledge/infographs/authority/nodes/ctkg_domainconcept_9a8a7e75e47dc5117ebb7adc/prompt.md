...
- One-line definition (source of truth): 李雅普诺夫函数是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「李雅普诺夫函数」、「一种·能量函数（李…」、「用于分析·stat…」、「应用于·Equil…」
