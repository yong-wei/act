...
- One-line definition (source of truth): Difference equations：Difference equations
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Discrete equivalent、Discrete design、Sample rate · 后续 → Discrete design、Discrete equivalent、Discrete signal
- Extended explanation (do not paste verbatim on image): Difference equations
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Difference …」、「Difference e」、「属于·Discre…」、「包含组件·Disc…」、「应用于·Sampl…」、「派生自·Discr…」
