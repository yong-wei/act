...
## Subject
- Title: 阻尼系数 (modeling_1f9d48d8fc305d13a1ad4763)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 两相伺服电动机机械特性线性化直线斜率Cω=dMm/dωm，即阻尼系数。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 两相伺服电动机机械特性线性化直线斜率Cω=dMm/dωm，即阻尼系数。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「阻尼系数」
