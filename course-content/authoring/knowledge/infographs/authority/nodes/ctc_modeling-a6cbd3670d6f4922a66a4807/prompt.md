...
## Subject
- Title: rectangular pulse of width (modeling_a6cbd3670d6f4922a66a4807)
- Concept kind: theoretical_construct
- One-line definition (source of truth): rectangular pulse of width：A rectangular pulse p_Δ(t) of width Δ and height 1/Δ, having unit area.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A rectangular pulse p_Δ(t) of width Δ and height 1/Δ, having unit area.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「rectangular…」
