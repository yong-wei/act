...
## Subject
- Title: 具有数字控制器的离散系统结构图
- Concept kind: unknown
- One-line definition (source of truth): 具有数字控制器的离散系统结构图是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「具有数字控制器的离散系…」
