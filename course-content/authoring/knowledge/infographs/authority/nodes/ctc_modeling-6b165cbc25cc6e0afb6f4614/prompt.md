...
## Subject
- Title: The rotational inertia of (modeling_6b165cbc25cc6e0afb6f4614)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The rotational inertia of：The rotational inertia of a point mass at distance l from the pivot, given by I = m l^2.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The rotational inertia of a point mass at distance l from the pivot, given by I = m l^2.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The rotatio…」
