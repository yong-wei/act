...
## Subject
- Title: Damped natural frequency omega d (Damped natural frequency omega_d)
- Concept kind: theoretical_construct
- One-line definition (source of truth): Damped natural frequency omega d：The damped natural frequency is the imaginary part of the complex pole location.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The damped natural frequency is the imaginary part of the complex pole location.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Damped natu…」
