...
## Subject
- Title: poles of l s (poles_of_l_s)
- Concept kind: mathematical_object
- One-line definition (source of truth): poles of l s：The roots of a(s)=0, labeled p_i.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → root of the denominator
- Extended explanation (do not paste verbatim on image): The roots of a(s)=0, labeled p_i.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「poles of l s」、「一种·root」
