...
## Subject
- Title: type of ideal element (modeling_cfe23fc89a7d2442f25e31e1)
- Concept kind: theoretical_construct
- One-line definition (source of truth): type of ideal element：A type of ideal element that dissipates energy, including electrical resistance, translational damper, rotational dampe…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A type of ideal element that dissipates energy, including electrical resistance, translational damp…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「type of ide…」
