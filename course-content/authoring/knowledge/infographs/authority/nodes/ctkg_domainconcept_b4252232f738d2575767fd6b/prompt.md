...
## Subject
- Title: Entry point in z-plane root locus
- Concept kind: unknown
- One-line definition (source of truth): Entry point in z-plane root locus是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Entry point…」
