...
- One-line definition (source of truth): 自振荡。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 极限环、稳定极限环、间隙特性
- Extended explanation (do not paste verbatim on image): 自振荡
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「自振荡」、「关联·极限环」、「关联·稳定极限环」、「关联·间隙特性」
