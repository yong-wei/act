...
## Subject
- Title: forward rectangu (forward rectangular integration for integral approximation)
- Concept kind: unknown
- One-line definition (source of truth): forward rectangu是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「forward rec…」
