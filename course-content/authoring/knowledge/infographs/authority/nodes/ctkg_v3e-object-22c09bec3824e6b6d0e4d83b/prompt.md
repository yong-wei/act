...
- One-line definition (source of truth): Phase-lead compensator：Phase-lead compensator
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Phase-lead compensator、超前校正网络、Phase-Lead Design Using the Bode Plot · 后续 → Compensator
- Extended explanation (do not paste verbatim on image): Phase-lead compensator
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Phase-lead …」、「Phase-lead c」、「一种·Phase-…」、「是一种·超前校正网络」、「一种·Compen…」、「用于分析·Phas…」、「用于分析·根轨迹」
