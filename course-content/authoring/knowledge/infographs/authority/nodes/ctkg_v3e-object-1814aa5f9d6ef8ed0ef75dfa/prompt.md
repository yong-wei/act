...
- One-line definition (source of truth): 振荡环节幅频特性出现峰值时所对应的频率，ω_r = ω_n √(1-2ζ²)，0<ζ≤√2/2。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 振荡环节幅频特性出现峰值时所对应的频率，ω_r = ω_n √(1-2ζ²)，0<ζ≤√2/2。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「谐振频率」
