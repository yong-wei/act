...
## Subject
- Title: Pole-zero cancel (Pole-zero cancellation in digital control design)
- Concept kind: unknown
- One-line definition (source of truth): Pole-zero cancel是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Pole-zero c…」
