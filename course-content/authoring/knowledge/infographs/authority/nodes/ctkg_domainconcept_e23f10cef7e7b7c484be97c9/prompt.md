...
## Subject
- Title: Lines of constan (Lines of constant damping ratio in z-plane)
- Concept kind: unknown
- One-line definition (source of truth): Lines of constan是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Lines of co…」
