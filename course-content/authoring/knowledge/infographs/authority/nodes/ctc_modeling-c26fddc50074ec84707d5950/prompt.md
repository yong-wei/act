...
## Subject
- Title: 系数矩阵各元素都是常数的线性系统 (modeling_c26fddc50074ec84707d5950)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 系数矩阵各元素都是常数的线性系统。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 系数矩阵各元素都是常数的线性系统。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「常数的线性系统」
