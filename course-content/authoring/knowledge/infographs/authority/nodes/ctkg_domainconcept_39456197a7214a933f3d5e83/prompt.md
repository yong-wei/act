...
## Subject
- Title: 有纹波最少拍系统结构图（图7-…
- Concept kind: unknown
- One-line definition (source of truth): 有纹波最少拍系统结构图（图7-…是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「有纹波最少拍系统结构图…」
