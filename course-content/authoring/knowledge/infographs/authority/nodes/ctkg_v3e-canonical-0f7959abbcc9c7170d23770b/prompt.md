...
- One-line definition (source of truth): 除闭环主导极点外，所有其他闭环极点由于其对应的响应分量随时间的推移迅速衰减，对系统的时间响应过程影响甚微，统称为非主导极点。
- Core intuition: 在图谱邻接中可把握：后续 → 闭环极点。
- Relation summary: 后续 → 闭环极点
- Extended explanation (do not paste verbatim on image): 除闭环主导极点外，所有其他闭环极点由于其对应的响应分量随时间的推移迅速衰减，对系统的时间响应过程影响甚微，统称为非主导极点。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「非主导极点」、「是一种·闭环极点」
