...
- One-line definition (source of truth): 如果系统所有状态变量的任意形式的运动均可由输出完全反映，则称系统是状态完全可观测的，简称为系统可观测；反之，则称系统是不完全可观测的，或简称为系统不可观测。
- Core intuition: 反之，则称系统是不完全可观测的，或简称为系统不可观测。
- Relation summary: 前置 → 系统完全可观测、系统不可观测
- Extended explanation (do not paste verbatim on image): 如果系统所有状态变量的任意形式的运动均可由输出完全反映，则称系统是状态完全可观测的，简称为系统可观测；反之，则称系统是不完全可观测的，或简称为系统不可观测。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「可观测性」、「一种·系统完全可观测」、「属于·系统完全可观测」、「属于·系统不可观测」
