...
## Subject
- Title: Nonminimum-Phase Compensator
- Concept kind: unknown
- One-line definition (source of truth): Nonminimum-Phase Compensator：Nonminimum-Phase Compensator
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → Zerodegree root locus
- Extended explanation (do not paste verbatim on image): Nonminimum-Phase Compensator
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Nonminimum-…」、「关联·Zerode…」
