...
- One-line definition (source of truth): 性能指标中的带宽频率 ω_b 的要求，是一项重要的技术指标。
- Core intuition: 无论采用哪种校正方式，都要求校正后的系统既能以所需精度跟踪输入信号，又能抑制噪声扰动信号。
- Relation summary: 后续 → 性能指标
- Extended explanation (do not paste verbatim on image): 性能指标中的带宽频率 ω_b 的要求，是一项重要的技术指标。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「系统带宽」、「是一种·性能指标」
