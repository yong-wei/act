...
- One-line definition (source of truth): Dominant poles：The poles at λ = -0.4 ± 0.3j are the dominant poles.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The poles at λ = -0.4 ± 0.3j are the dominant poles.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Dominant po…」、「Dominant pol」
