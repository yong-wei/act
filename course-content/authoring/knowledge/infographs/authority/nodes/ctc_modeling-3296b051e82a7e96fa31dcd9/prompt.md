...
## Subject
- Title: 求解离散动态方程的一种常用方法 (modeling_3296b051e82a7e96fa31dcd9)
- Concept kind: analysis_method
- One-line definition (source of truth): 求解离散动态方程的一种常用方法，通过令 k=0,1,...,k-1 递推得到各时刻的状态。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 求解离散动态方程的一种常用方法，通过令 k=0,1,...,k-1 递推得到各时刻的状态。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「求解离散动态方程的一种…」
