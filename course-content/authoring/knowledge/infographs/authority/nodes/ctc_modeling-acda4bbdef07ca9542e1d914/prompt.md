...
## Subject
- Title: type of ideal element (modeling_acda4bbdef07ca9542e1d914)
- Concept kind: theoretical_construct
- One-line definition (source of truth): type of ideal element：A type of ideal element that stores energy in a capacitive form, including capacitance, mass, moment of inertia, fluid…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A type of ideal element that stores energy in a capacitive form, including capacitance, mass, momen…
