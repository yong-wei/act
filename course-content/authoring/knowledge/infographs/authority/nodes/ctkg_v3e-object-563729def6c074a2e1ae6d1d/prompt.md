...
- One-line definition (source of truth): 继电特性。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → 自激振荡
- Extended explanation (do not paste verbatim on image): 继电特性
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「继电特性」、「关联·自激振荡」
