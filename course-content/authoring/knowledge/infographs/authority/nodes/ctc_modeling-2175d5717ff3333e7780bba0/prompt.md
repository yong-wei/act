...
## Subject
- Title: 线性定常微分方程的求解方法有经… (modeling_2175d5717ff3333e7780bba0)
- Concept kind: analysis_method
- One-line definition (source of truth): 线性定常微分方程的求解方法有经典法和拉普拉斯变换法两种，也可借助电子计算机求解。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 线性定常微分方程的求解方法有经典法和拉普拉斯变换法两种，也可借助电子计算机求解。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「线性定常微分方程的求解…」
