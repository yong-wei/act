...
- One-line definition (source of truth): 采样频谱中 n=±1, ±2, ... 的高频频谱，由采样引起。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 采样频谱主分量
- Extended explanation (do not paste verbatim on image): 采样频谱中 n=±1, ±2, ... 的高频频谱，由采样引起。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「采样频谱补分量」、「关联·采样频谱主分量」
