...
## Subject
- Title: The plane of position (modeling_50096472169ff29f3d25b2d1)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The plane of position：The plane of position versus velocity of a particle or rigid body.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The plane of position versus velocity of a particle or rigid body.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The plane o…」
