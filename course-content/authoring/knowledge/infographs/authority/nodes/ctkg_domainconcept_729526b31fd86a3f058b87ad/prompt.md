...
## Subject
- Title: Constant damping ratio curves in z-plane
- Concept kind: unknown
- One-line definition (source of truth): Constant damping ratio curves in z-plane是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Constant da…」
