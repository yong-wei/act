...
- One-line definition (source of truth): Final Value Theorem：Final Value Theorem
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → Partial-fraction expansion
- Extended explanation (do not paste verbatim on image): Final Value Theorem
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Final Value…」、「Final Value 」、「派生自·Parti…」
