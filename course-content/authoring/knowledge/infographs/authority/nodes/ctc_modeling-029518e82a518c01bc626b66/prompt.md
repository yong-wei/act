...
## Subject
- Title: 领域概念 (modeling_029518e82a518c01bc626b66)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 领域概念：A mechanical system consisting of a mass suspended from a pivot by a rod or string, used to analyze dynamics under grav…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A mechanical system consisting of a mass suspended from a pivot by a rod or string, used to analyze…
