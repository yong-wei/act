...
- One-line definition (source of truth): Analog-to-digital converter：Analog-to-digital converter
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → Amplitude quantization error
- Extended explanation (do not paste verbatim on image): Analog-to-digital converter
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Analog-to-d…」、「关联·Amplit…」
