...
## Subject
- Title: The natural or unforced (modeling_921bc3037657731382363bae)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The natural or unforced：The natural or unforced behavior of the system, determined by the poles of the system.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The natural or unforced behavior of the system, determined by the poles of the system.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The natural…」
