...
## Subject
- Title: 状态空间表达式中n×n的系数矩阵 (modeling_6212bcf51507051ef6765954)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 状态空间表达式中n×n的系数矩阵，也称状态矩阵。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 状态空间表达式中n×n的系数矩阵，也称状态矩阵。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「状态空间表达式中n×n…」
