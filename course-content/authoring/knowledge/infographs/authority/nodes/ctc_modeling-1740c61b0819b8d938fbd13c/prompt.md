...
## Subject
- Title: The matrix sI (modeling_1740c61b0819b8d938fbd13c)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The matrix sI：The matrix Φ(s) = (sI - A)^{-1}.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The matrix Φ(s) = (sI - A)^{-1}.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The matrix …」
