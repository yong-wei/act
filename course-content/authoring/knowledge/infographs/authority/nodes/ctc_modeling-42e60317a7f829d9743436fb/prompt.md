...
## Subject
- Title: The roots of the (modeling_42e60317a7f829d9743436fb)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The roots of the：The roots of the characteristic equation are called the poles of the system. At the poles, the function Y(s) becomes in…
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The roots of the characteristic equation are called the poles of the system. At the poles, the func…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The roots o…」
