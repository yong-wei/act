...
- One-line definition (source of truth): Discrete Models是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Discrete Mo…」、「Discrete Mod」
