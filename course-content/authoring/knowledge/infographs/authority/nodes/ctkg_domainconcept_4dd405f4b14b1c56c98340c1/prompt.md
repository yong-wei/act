...
- Relation summary: 后续 → state space model、Equilibrium Point
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Lyapunov fu…」、「Lyapunov fun」、「用于分析·stat…」、「应用于·Equil…」
