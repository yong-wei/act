...
- One-line definition (source of truth): 采样频谱中 n=0 的频谱，与连续频谱形状一致，幅值变化为 1/T。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → 采样频谱补分量
- Extended explanation (do not paste verbatim on image): 采样频谱中 n=0 的频谱，与连续频谱形状一致，幅值变化为 1/T。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「采样频谱主分量」、「关联·采样频谱补分量」
