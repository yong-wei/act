...
## Subject
- Title: 回路中所有支路增益之乘积 (modeling_4c7a0114a15c9e4039f6d193)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 回路中所有支路增益之乘积，用 L_a 表示。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 回路中所有支路增益之乘积，用 L_a 表示。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「回路中所有支路增益之乘积」
