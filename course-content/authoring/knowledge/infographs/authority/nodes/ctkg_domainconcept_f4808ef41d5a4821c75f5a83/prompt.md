...
## Subject
- Title: PID控制器 (PID controller)
- Concept kind: unknown
- One-line definition (source of truth): PID控制器是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「PID控制器」、「PID controll」
