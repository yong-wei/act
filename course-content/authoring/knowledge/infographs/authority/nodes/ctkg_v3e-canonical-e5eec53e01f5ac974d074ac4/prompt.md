...
- One-line definition (source of truth): 对于图3-8所示的单位反馈系统，误差响应为 e(t)=r(t)-c(t)。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → 稳态误差
- Extended explanation (do not paste verbatim on image): 对于图3-8所示的单位反馈系统，误差响应为 e(t)=r(t)-c(t)。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「误差响应」、「关联·稳态误差」
