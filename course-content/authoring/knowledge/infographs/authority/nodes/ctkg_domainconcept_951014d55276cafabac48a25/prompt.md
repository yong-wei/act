...
- One-line definition (source of truth): Lyapunov equation是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Lyapunov eq…」、「Lyapunov equ」
