...
## Subject
- Title: The complex plane used (modeling_b51e05d922d0e35d648451de)
- Concept kind: theoretical_construct
- One-line definition (source of truth): The complex plane used：The complex plane used to display the locations of poles and zeros of a transfer function.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The complex plane used to display the locations of poles and zeros of a transfer function.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「The complex…」
