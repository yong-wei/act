...
## Subject
- Title: First column of Routh array
- Concept kind: unknown
- One-line definition (source of truth): First column of Routh array：First column of Routh array
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → Routh array
- Extended explanation (do not paste verbatim on image): First column of Routh array
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「First colum…」、「属于·Routh …」
