...
## Subject
- Title: scalar in the state-variable (modeling_e96fa139bbc059f3e779e62e)
- Concept kind: theoretical_construct
- One-line definition (source of truth): scalar in the state-variable：A scalar in the state-variable form.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A scalar in the state-variable form.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「scalar in t…」
