...
- One-line definition (source of truth): 增益：v3T accepted candidate for gain.。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → ultimate gain、K_G*、根轨迹增益
- Extended explanation (do not paste verbatim on image): v3T accepted candidate for gain.
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「增益」、「gain」、「一种·ultima…」、「是一种·K G*」、「是一种·根轨迹增益」、「应用于·graph…」、「应用于·gain …」
