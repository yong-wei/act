...
## Subject
- Title: Neutrally stable
- Concept kind: unknown
- One-line definition (source of truth): Neutrally stable：A system with nonrepeated jω axis poles is said to be neutrally stable
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): A system with nonrepeated jω axis poles is said to be neutrally stable
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Neutrally s…」、「Neutrally st」
