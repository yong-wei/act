...
- One-line definition (source of truth): Natural response：Natural response
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → impulse response、Fast pole and slow pole
- Extended explanation (do not paste verbatim on image): Natural response
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Natural res…」、「Natural resp」、「一种·impuls…」、「关联·Fast p…」
