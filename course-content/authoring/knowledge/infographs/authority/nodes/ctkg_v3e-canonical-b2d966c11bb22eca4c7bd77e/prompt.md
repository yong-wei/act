...
## Subject
- Title: Poles and zeros of T(s)
- Concept kind: theoretical_construct
- One-line definition (source of truth): Poles and zeros of T(s)：The poles of T(s) are the roots of the characteristic equation Δ(s)=0
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The poles of T(s) are the roots of the characteristic equation Δ(s)=0
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Poles and z…」、「Poles and ze」
