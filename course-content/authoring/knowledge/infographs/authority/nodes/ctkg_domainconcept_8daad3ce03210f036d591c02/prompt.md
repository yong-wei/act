...
## Subject
- Title: stability in the large
- Concept kind: unknown
- One-line definition (source of truth): stability in the large是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「stability i…」、「stability in」
