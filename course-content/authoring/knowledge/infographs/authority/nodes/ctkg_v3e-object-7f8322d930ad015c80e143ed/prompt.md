...
- One-line definition (source of truth): Digital-to-analog converter：Digital-to-analog converter
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 后续 → Sampled-data system、Continuous signal
- Extended explanation (do not paste verbatim on image): Digital-to-analog converter
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Digital-to-…」、「属于·Sample…」、「关联·Contin…」
