...
- One-line definition (source of truth): Bel：A unit of power gain named after Alexander Graham Bell, later subdivided into decibels for practical use.
- Core intuition: 在图谱邻接中可把握：前置 → Decibel (dB)。
- Relation summary: 前置 → Decibel (dB)
- Extended explanation (do not paste verbatim on image): A unit of power gain named after Alexander Graham Bell, later subdivided into decibels for practica…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Bel」、「属于·Decibe…」、「派生自·Decib…」、「关联·Decibe…」
