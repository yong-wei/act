...
- One-line definition (source of truth): 凡以二阶微分方程描述运动方程的控制系统，称为二阶系统。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: 前置 → 有零点的二阶系统
- Extended explanation (do not paste verbatim on image): 凡以二阶微分方程描述运动方程的控制系统，称为二阶系统。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「二阶系统」、「一种·有零点的二阶…」
