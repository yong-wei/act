...
## Subject
- Title: 单位反馈线性定常离散系统（例7…
- Concept kind: unknown
- One-line definition (source of truth): 单位反馈线性定常离散系统（例7…是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「单位反馈线性定常离散系…」
