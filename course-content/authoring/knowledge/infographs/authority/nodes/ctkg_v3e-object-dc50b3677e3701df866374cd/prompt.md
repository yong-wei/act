...
## Subject
- Title: Analog-to-digital (A/D) converter
- Concept kind: unknown
- One-line definition (source of truth): Analog-to-digital (A/D) converter：Analog-to-digital (A/D) converter
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): Analog-to-digital (A/D) converter
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Analog-to-d…」
