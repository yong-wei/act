...
## Subject
- Title: Resonant-peak magnitude Mr
- Concept kind: unknown
- One-line definition (source of truth): Resonant-peak magnitude Mr：The resonant-peak magnitude Mr is a specification related to the closed-loop frequency response, defined in Fig. 6.5.
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): The resonant-peak magnitude Mr is a specification related to the closed-loop frequency response, de…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Resonant-pe…」
