...
## Subject
- Title: 用线性微分方程描述的元件或系统 (modeling_542407d995b04730d1803912)
- Concept kind: theoretical_construct
- One-line definition (source of truth): 用线性微分方程描述的元件或系统。
- Core intuition: 抓住定义核心与邻接关系，不扩展未给出的事实。
- Relation summary: （权威图邻接待补充）
- Extended explanation (do not paste verbatim on image): 用线性微分方程描述的元件或系统。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「用线性微分方程描述的元…」
