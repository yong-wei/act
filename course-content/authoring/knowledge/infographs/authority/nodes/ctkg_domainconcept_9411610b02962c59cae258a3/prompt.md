...
## Subject
- Title: G_c(s)-D(z) 变换方法
- Concept kind: unknown
- One-line definition (source of truth): G_c(s)-D(z) 变换方法是自动控制原理权威图谱中的领域概念。
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「G_c(s)-D(z)…」
