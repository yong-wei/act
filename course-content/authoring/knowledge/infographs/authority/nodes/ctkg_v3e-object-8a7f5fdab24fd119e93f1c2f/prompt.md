...
- One-line definition (source of truth): Resonant frequency：The resonant frequency ω_r and the -3 dB bandwidth can be related to the speed of the transient response.
- Core intuition: 在图谱邻接中可把握：前置 → Resonant peak、阻尼比、Resonant magnitude · 后续 → Bandwidth frequency、带宽、Resonant magnitude。
- Relation summary: 前置 → Resonant peak、阻尼比、Resonant magnitude · 后续 → Bandwidth frequency、带宽、Resonant magnitude
- Extended explanation (do not paste verbatim on image): The resonant frequency ω_r and the -3 dB bandwidth can be related to the speed of the transient res…
...
- Allowed visible labels (max ~10, each preferably ≤10 Chinese characters): 「Resonant fr…」、「Resonant fre」、「关联·Resona…」、「关联·Bandwi…」、「关联·带宽」、「关联·阻尼比」
