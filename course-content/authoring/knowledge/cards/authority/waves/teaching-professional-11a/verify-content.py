"""Verify teaching-professional-11a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["robustness", "robust_system", "model_inaccuracy", "unmodeled_dynamics", "parameter_bounds", "additive", "multiplicative", "robust_stability"]))
