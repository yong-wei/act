"""Verify teaching-core-19a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["proportional", "pi_trials", "integral", "pd", "equivalent_gain", "integral_augmentation", "zn_tuning", "proportional_units"]))
