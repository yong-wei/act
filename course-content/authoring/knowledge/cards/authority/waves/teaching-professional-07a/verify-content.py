"""Verify teaching-professional-07a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["minimum_time", "weight_R", "weight_Q", "weight_F", "linear_quadratic", "lqr", "transversality", "finite_horizon_feedback"]))
