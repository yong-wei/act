"""Verify teaching-professional-06a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["minimum_effort", "functional", "running_cost", "terminal_cost", "variations", "minimum_principle", "dynamic_programming"]))
