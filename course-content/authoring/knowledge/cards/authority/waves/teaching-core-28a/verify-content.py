"""Verify teaching-core-28a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["stable_limit_cycle", "semistable_cycle", "relay_describing_function", "harmonic_balance", "quantization"]))
