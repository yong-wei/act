...
orders={'stability-concepts-foundations':[1,4,6,7],'frequency-response-foundations':[3,5,9,10],'discrete-control-foundations':[2,8,11]}
...
print('Registered 11 reviewed targets across existing design and feedback-structure goals')
