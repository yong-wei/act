"""Verify teaching-core-25a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["first_order_bandwidth", "second_order", "overdamped_counterexample", "low_frequency", "corner", "frequency_distinction"]))
