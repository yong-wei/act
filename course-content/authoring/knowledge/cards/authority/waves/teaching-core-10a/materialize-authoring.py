"""Materialize nine fixed bodies with exact source and relation metadata."""
...
pred={'association':'相关','is_a':'属于','part_of':'组成部分属于','has_formula':'具有公式','derived_from':'推导自','applies_to':'适用于','has_representation':'有表示','prerequisite':'前置于','has_component':'包含组件'}
for row in s['cards']:
    ...
    for r,other in candidates[:3]:
        # Exclude the unresolved impulse/natural-response taxonomy from teaching cards.
        if r["id"] == "ctr:m1f-bridge-relation-ad5c8e4d866cbe9847b254cd": continue
...
print('Materialized nine candidate cards with exact relations')
