...
for card in inventory["cards"]:
    ...
    node_id = re.search(r'^node_id:\s*(.+)$', data.decode(), re.M)
    assert node_id and node_id.group(1).strip().strip('"\'') == card["cardId"], "Frontmatter node_id mismatch"
...
ledger["batchId"] = "teaching-batches-01-02-scale-01-01b-01d-01c-01f-01e-01h-01g-core-01a-core-02a-core-04a-core-03a-core-06a-core-05a-core-07a-core-09a-core-08a-core-10a-core-11a-core-12a"
