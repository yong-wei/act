"""Verify teaching-professional-01a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["aliasing", "nyquist_boundary", "sample_hold", "sample_rate_design", "prefilter", "ideal_sampler", "sampled_feedback", "sampling_phase"]))
