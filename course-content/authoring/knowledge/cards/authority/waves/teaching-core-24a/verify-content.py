"""Verify teaching-core-24a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["first_order_frequency", "forced_response", "lead_design", "phase_boundary", "unstable_counterexample"]))
