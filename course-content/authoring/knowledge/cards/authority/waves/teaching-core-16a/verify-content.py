"""Verify teaching-core-16a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["controllability_gramian", "auxiliary", "first_column_zero", "parameter_range", "axis_shift", "absolute_stability_context", "routh_approximation"]))
