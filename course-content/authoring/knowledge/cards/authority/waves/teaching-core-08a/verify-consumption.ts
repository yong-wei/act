...
assert.deepEqual(inventories[18].cards.map((c: any) => c.canonicalId).sort(), acceptedScope.cards.map((c: any) => c.canonicalId).sort());
assert.equal(cards.length, 147 + acceptedScope.cards.length);
...
for (const name of ['teaching-batch-01', 'teaching-batch-02', 'teaching-scale-01', 'teaching-scale-01b', 'teaching-scale-01d', 'teaching-scale-01c', 'teaching-scale-01f', 'teaching-scale-01e', 'teaching-scale-01h', 'teaching-scale-01g', 'teaching-core-01a', 'teaching-core-02a', 'teaching-core-04a', 'teaching-core-03a', 'teaching-core-06a', 'teaching-core-05a', 'teaching-core-07a', 'teaching-core-09a', 'teaching-core-08a']) {
  ...
  if (name === 'teaching-core-08a') {
    ...
    assert.deepEqual(receipt.batchCanonicalIds, inventories[18].cards.map((c: any) => c.canonicalId).sort());
  }
