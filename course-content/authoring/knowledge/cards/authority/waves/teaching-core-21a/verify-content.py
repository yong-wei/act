"""Verify teaching-core-21a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["feedforward", "disturbance_location", "prefilter", "reference_internal_model", "feedforward_stability_boundary", "reference_prefilter_equivalence"]))
