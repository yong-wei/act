...
orders={'state-space-analysis-foundations':[1,2,3,8,9,10], 'state-space-controllability-foundations':[4,5,6,7]}
...
print('Registered 10 reviewed targets across existing state-space goals')
