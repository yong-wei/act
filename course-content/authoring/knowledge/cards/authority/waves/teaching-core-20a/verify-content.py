"""Verify teaching-core-20a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["velocity_feedback", "placement", "lead", "lag", "lead_closed_example", "wrong_velocity_sign", "lead_inverse_design"]))
