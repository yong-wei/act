"""Verify teaching-core-15a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["imaginary_crossing", "oscillator", "half_planes", "stable_sine", "rhp_zero_stable_channel", "stable_bibo", "conditional_gain", "motion"]))
