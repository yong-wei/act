"""Verify teaching-core-27a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["saturation", "dead_zone", "relay_hysteresis", "ideal_relay", "backlash_play", "coulomb_slide", "stiction", "coulomb_viscous", "integrator_saturation", "dynamic_nonadditivity", "dead_zone_inverse"]))
