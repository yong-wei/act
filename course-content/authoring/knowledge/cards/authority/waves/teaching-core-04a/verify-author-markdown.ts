...
try {
  for (const name of ['teaching-core-04a']) {
...
writeFileSync(join(waves, 'teaching-core-04a/author-markdown-verification.json'), JSON.stringify({ status: 'passed', runtimeWritten: false, results }, null, 2) + '\n');
