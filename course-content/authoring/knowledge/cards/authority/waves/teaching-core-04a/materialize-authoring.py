"""Materialize ten fixed bodies with exact source and relation metadata."""
...
for row in s['cards']:
    ...
    body+='\n\n### 关联节点\n\n'+ ('\n'.join(e['renderedLine'] for e in entries) if entries else '本卡的核心结论可由上述状态方程与能量关系独立复核。')+'\n'
...
print('Materialized ten candidate cards with exact relations')
