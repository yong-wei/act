"""Verify teaching-core-22a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["loop_functions", "parameter_derivatives", "finite_perturbations", "channels", "near_critical", "time_response", "parameterization", "dc_insensitive_example"]))
