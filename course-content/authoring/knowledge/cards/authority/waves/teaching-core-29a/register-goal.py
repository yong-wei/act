...
orders={'stability-concepts-foundations':[1,2,3,4,6,7,8,9,10],'control-correction':[5]}
...
print('Registered 10 reviewed targets across existing design and feedback-structure goals')
