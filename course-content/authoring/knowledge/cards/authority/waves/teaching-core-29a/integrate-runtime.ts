...
const priorBatchIds = ['teaching-batch-01', 'teaching-batch-02', 'teaching-scale-01', 'teaching-scale-01b', 'teaching-scale-01d', 'teaching-scale-01c', 'teaching-scale-01f', 'teaching-scale-01e', 'teaching-scale-01h', 'teaching-scale-01g', 'teaching-core-01a', 'teaching-core-02a', 'teaching-core-04a', 'teaching-core-03a', 'teaching-core-06a', 'teaching-core-05a', 'teaching-core-07a', 'teaching-core-09a', 'teaching-core-08a', 'teaching-core-10a', 'teaching-core-11a', 'teaching-core-12a', 'teaching-core-13a', 'teaching-core-14a', 'teaching-core-15a', 'teaching-core-16a', 'teaching-core-17a', 'teaching-core-18a', 'teaching-core-19a', 'teaching-core-20a', 'teaching-core-21a', 'teaching-core-22a', 'teaching-core-23a', 'teaching-core-24a', 'teaching-core-25a', 'teaching-core-26a', 'teaching-core-27a', 'teaching-core-28a'];
const currentBatchId = inventory.batchId;
assert(!priorBatchIds.includes(currentBatchId), 'Current batch must be appended exactly once');
const cumulativeBatchIds = [...priorBatchIds, currentBatchId];
const knownCards = cumulativeBatchIds.flatMap((name) => read(join(batch, '..', name, 'inventory.json')).cards);
