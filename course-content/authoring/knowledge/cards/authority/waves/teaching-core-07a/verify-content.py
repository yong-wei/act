"""Verify teaching-core-07a authoring cards without runtime writes."""
...
EXPECTED_IDS = ['ctc:0f418dc24d2aacaaafdcdcc0', 'ctc:modeling-07799c3f876317e36fe669f8', 'ctc:modeling-50ed406e4478b481d868adfb', 'ctc:modeling-57c56ef58df2315f765a32dc', 'ctc:modeling-9b8a43928af77103270d5f9c', 'ctc:modeling-e8a0502ecb67f574a5cb6c1b']
...
def model_claim_checks(cards, models):
    snippets=[
        ['P_1=2\\times3\\times1=6', 'P_2=1\\times1=1', 'P_3=4\\times0.5=2', '205/26'],
        ['26}{25', '1.04', 'L_1L_2=-', '两个基本回路'],
        ['Delta_1=1-L_2', 'Delta_3=1-L_1', '13}{10'],
        ['41}{5', '205}{26', '225/26', '独立消元'],
        ['没有任何共同节点', '共同影响输出', '26}{25'],
        ['+L_1L_2', 'Delta_1=1-L_2', 'Delta_3=1-L_1', '41/5'],
    ]
    true('six model-backed topics',len(models)==6)
...
def verify_parser_and_katex(cards: list[dict[str, object]]) -> dict[str, object]:
    with tempfile.TemporaryDirectory(prefix="teaching-core-07a-parser-") as temp:
        env = os.environ.copy()
        env.update({
