...
try {
  for (const name of ['teaching-core-07a']) {
...
writeFileSync(join(waves, 'teaching-core-07a/author-markdown-verification.json'), JSON.stringify({ status: 'passed', runtimeWritten: false, results }, null, 2) + '\n');
