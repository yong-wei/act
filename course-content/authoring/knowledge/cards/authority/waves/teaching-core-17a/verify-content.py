"""Verify teaching-core-17a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["path_gains", "point_gain", "cubic_locus", "break_in", "gain_tuning", "zero_degree", "negative_gain_stable_counterexample"]))
