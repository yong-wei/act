"""Verify teaching-professional-05a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["definiteness", "stable_rotation", "cubic_asymptotic", "uniform_stability", "uniform_asymptotic", "global_asymptotic", "candidate_failure", "lyapunov_equation", "energy_lasalle", "indirect_method", "direct_method"]))
