"""Verify teaching-professional-12a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["qft", "robust_design", "uncertainty_design", "time_weighted_error", "robust_simulation", "itae_method", "robust_zero_offset"]))
