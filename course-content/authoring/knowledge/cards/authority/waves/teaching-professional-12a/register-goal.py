"""Bind the reviewed robust design topics to existing semantically suitable goals."""
import hashlib,json
...
orders={'robust-control-foundations':list(range(1,8))}
...
print('Registered 7 reviewed targets in the existing robust-control goal')
