...
try {
  for (const name of ['teaching-core-01a', 'teaching-core-02a']) {
...
writeFileSync(join(waves, 'teaching-core-02a/author-markdown-verification.json'), JSON.stringify({ status: 'passed', runtimeWritten: false, results }, null, 2) + '\n');
