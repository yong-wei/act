"""Verify teaching-professional-02a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["z_transform", "difference_equation", "zoh", "foh_extrapolation", "finite_word", "sampled_metrics", "source_w_convention", "tustin", "exponential_mapping"]))
