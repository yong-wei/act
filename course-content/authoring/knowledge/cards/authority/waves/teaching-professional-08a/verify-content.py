"""Verify teaching-professional-08a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["unit_circle", "sampling_period", "discrete_model", "exact_zoh", "proportional", "integral", "derivative"]))
