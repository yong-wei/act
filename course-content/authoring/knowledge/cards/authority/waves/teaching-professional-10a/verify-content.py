"""Verify teaching-professional-10a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["plant", "sample_deadbeat", "deadbeat_design", "error_transfer", "ripple", "ripple_free", "ripple_free_design", "one_step"]))
