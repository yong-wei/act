"""Verify teaching-core-18a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["departure", "arrival", "breakaway", "finite_zero_centroid", "asymptotes", "parameter_family", "open_loop_poles", "bode_breakpoint"]))
