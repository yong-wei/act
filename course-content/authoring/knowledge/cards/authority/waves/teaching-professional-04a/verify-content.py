"""Verify teaching-professional-04a authoring cards without runtime writes."""
...
def model_claim_checks(cards, models):
    true("model report has expected sections", all(key in models for key in
        ["state_feedback", "ackermann_control", "full_observer", "ackermann_observer", "stabilizability_detectability", "reduced_observer", "separation", "kalman_decomposition", "internal_model"]))
