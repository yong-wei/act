...
\begin{tikzpicture}[>=Stealth, line width=1.2pt, font=\small]
  ...
  \node[below] at (7.2,-4.15) {绕原点逆时针};
  \node[above] at (7.2,-1.7) {$R=+1$};

  \node[align=left] at (4.6,-5.6) {$\displaystyle R=P-Z$\\零点贡献 $-1$，极点贡献 $+1$};
\end{tikzpicture}
\end{document}
