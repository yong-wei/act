...
\begin{tikzpicture}[>=Stealth, line width=1.2pt, font=\small]
  ...
  \node[align=center] at (1.8,2.55) {围绕整个右半平面的\\奈奎斯特路径};
  ...
  \node[align=left, anchor=west] at (10.7,0.3) {上支：$\omega:0\to+\infty$\\下支：共轭映像};
  \node[align=left, anchor=west] at (9.2,-2.65) {原点处的小绕行\\$\Rightarrow$ 像平面中的大圆弧};
\end{tikzpicture}
\end{document}
