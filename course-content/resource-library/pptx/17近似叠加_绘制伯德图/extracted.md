...
3. 采用对数频率坐标后，每个十倍频程占据相同视觉宽度，更适合分析“转折频率”和“斜率变化”。
...
![伯德图手工绘制的五步流程](tikz/rendered/02-bode-steps.png)
...
则幅频渐近线的斜率会在每个转折频率之后再下降 $20\,\mathrm{分贝/十倍频程}$。
...
![根据伯德图反求传函的判读卡](tikz/rendered/03-reverse-identification-card.png)
