...
第 5 页用电阻电感电容电路微分方程做前测，实际作用不是再教一次建模，而是为“从微分方程走向传递函数”做铺垫。
...
![电阻电感电容电路由微分方程到传递函数](tikz/rendered/04-rlc-transfer-example.png)

### 6.2 含负载效应的电路（第 17 页）

第 17 页把简单电阻电感电容电路推广到含负载效应的电路，给出的标准式为：
...
它和前面的电阻电感电容电路看起来属于不同学科，但形式完全平行。
...
第 21 页是整讲最值得复用的一页。它把电阻电感电容电路和质量-阻尼-弹簧系统放到同一个模板下：
...
- 电阻电感电容电路对应 $a_0=LC,\ a_1=RC,\ a_2=1$；
...
![电阻电感电容电路与机械系统的统一二阶模板](tikz/rendered/08-structural-similarity.png)

## 8. 数值软件 命令页（第 22-23 页）
...
3. 传递函数只适用于单输入单输出关系，多输入多输出系统应改用传递函数矩阵。
4. 系统阶次、特征多项式、特征根、零点、极点之间的对应关系。
5. 电阻电感电容电路、带负载电路、机械系统和电机系统的跨领域平行案例。
