...
\begin{tikzpicture}[
  ...
  \node[align=center] at (-4.5,-2.5) {电阻电感电容电路\\$G(s)=\dfrac{1}{LCs^2+RCs+1}$};
  ...
  \node at (2.1,0.7) {$K$};
  \node at (2.15,-0.35) {$B$};
  \node[align=center] at (2.9,-2.5) {机械系统\\$G(s)=\dfrac{1}{Ms^2+Bs+K}$};
  ...
  \node[align=left] at (-0.8,4.0) {
    电阻电感电容电路：$a_0=LC,\ a_1=RC,\ a_2=1$\\
    机械系统：$a_0=M,\ a_1=B,\ a_2=K$
  };
\end{tikzpicture}
\end{document}
