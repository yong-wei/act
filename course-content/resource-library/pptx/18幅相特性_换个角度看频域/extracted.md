...
就在复平面上形成一条轨迹。这条轨迹就是开环幅相特性，也就是极坐标图 / 奈奎斯特图的基础对象。
...
3. 这些特征点在 伯德图上也能找到对应频率点，因此两种图形不是割裂的。
...
![伯德图与极坐标图之间的对应关系](tikz/rendered/05-bode-nyquist-link.png)
