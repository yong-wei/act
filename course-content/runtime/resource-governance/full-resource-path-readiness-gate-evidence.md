...
- [warning] resource-type-audit-missing: 8 - Required future import resource types are not currently represented in helper output; future imports must not bypass this audit.
