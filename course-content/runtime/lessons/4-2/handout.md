...
![封面漫画：单元导入](/course-runtime/lessons/4-2/media/4-2-cover-comic.png)
...
![客船航向控制跨域图（复用 4-1 证据）](/course-runtime/lessons/4-2/media/4-1-ship-heading-quad.png){width=100%}
...
![船载稳定平台跨域图（复用 4-1 证据）](/course-runtime/lessons/4-2/media/4-1-platform-pitch-quad.png){width=100%}
...
![前馈补偿结构示意](/course-runtime/lessons/4-2/media/4-2-feedforward-block-diagram.png){width=84%}
...
![本讲信息图总结](/course-runtime/lessons/4-2/media/4-2-info.png)
