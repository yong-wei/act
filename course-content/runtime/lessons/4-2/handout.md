...
![客船航向控制跨域图](/course-runtime/lessons/4-2/media/4-1-ship-heading-quad.png){width=100%}
...
![船载稳定平台跨域图](/course-runtime/lessons/4-2/media/4-1-platform-pitch-quad.png){width=100%}
...
![按输入补偿前馈与 PD 的结构对比](/course-runtime/lessons/4-2/media/4-2-input-feedforward-vs-pd-structure.png){width=100%}
...
![固定反馈策略下有无输入前馈的四联对比](/course-runtime/lessons/4-2/media/4-2-input-feedforward-quad.png){width=100%}
...
![只有反馈与反馈加扰动前馈的结构对比](/course-runtime/lessons/4-2/media/4-2-disturbance-feedforward-structure-compare.png){width=100%}
...
![固定反馈策略下有无扰动前馈的四联对比](/course-runtime/lessons/4-2/media/4-2-disturbance-feedforward-quad.png){width=100%}
