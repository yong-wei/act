...
- 步骤 `step-04` 的互动契约缺少字段：content_blocks
- 步骤 `step-05` 的互动契约缺少字段：content_blocks
- 步骤 `step-06` 的互动契约缺少字段：content_blocks
- 步骤 `step-07` 的互动契约缺少字段：content_blocks
- 步骤 `step-11` 的互动契约缺少字段：content_blocks
- 步骤 `step-12` 的互动契约缺少字段：content_blocks
