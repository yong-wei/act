...
![封面漫画：时域与频域——同一个系统的两张面孔](/course-runtime/lessons/1-4/media/1-4-cover-comic.png)
...
![三组比例增益对应的单位负反馈闭环阶跃响应](/course-runtime/lessons/1-4/media/1-4-fig-01-step-responses.png){width=60%}
...
![K等于8时闭环指令传递函数的Bode图，并标出负3分贝带宽](/course-runtime/lessons/1-4/media/1-4-fig-02-closed-loop-bode.png){width=60%}
...
![对象G0的开环Bode图，低频呈积分环节斜率并在4弧度每秒附近继续转折](/course-runtime/lessons/1-4/media/1-4-fig-03-open-loop-bode.png){width=60%}
...
![对象G0的正频率响应支位于第三象限，负频率支关于实轴镜像](/course-runtime/lessons/1-4/media/1-4-fig-04-open-loop-nyquist.png){width=60%}
...
![K等于8时闭环极点、阶跃响应、环路开环Bode幅频和Nyquist轨迹并置](/course-runtime/lessons/1-4/media/1-4-fig-05-four-views.png){width=90%}
...
![K等于8时闭环极点、阶跃响应和闭环指令频率响应并置](/course-runtime/lessons/1-4/media/1-4-fig-06-three-domain-reading.png){width=90%}
...
![单元封底信息图：时域与频域——同一个系统的两张面孔](/course-runtime/lessons/1-4/media/1-4-info.png)
