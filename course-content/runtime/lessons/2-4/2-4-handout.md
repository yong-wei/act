...
![同一对象的 Bode / Nyquist 一致性对照](/course-runtime/lessons/2-4/media/2-4-fd-08-bode-nyquist-consistency-panel.svg){width=100%}
...
![一阶惯性环节 Nyquist 轨迹与方向](/course-runtime/lessons/2-4/media/2-4-fd-05-first-order-nyquist-track.svg){width=60%}
...
![纯极点系统 Nyquist 轨迹比较](/course-runtime/lessons/2-4/media/2-4-fd-06-pure-pole-nyquist-comparison.svg){width=60%}
