...
![封面漫画：单元导入](/course-runtime/lessons/2-4/media/2-4-cover-comic.png)
...
![同一对象的 Bode / Nyquist 一致性对照](/course-runtime/lessons/2-4/media/2-4-fd-08-bode-nyquist-consistency-panel.svg)
...
![一阶惯性环节 Nyquist 轨迹与方向](/course-runtime/lessons/2-4/media/2-4-fd-05-first-order-nyquist-track.svg)
...
![纯极点系统 Nyquist 轨迹比较](/course-runtime/lessons/2-4/media/2-4-fd-06-pure-pole-nyquist-comparison.svg)
...
![Bode 图手绘检查单](/course-runtime/lessons/2-4/media/2-4-fd-09-bode-sketch-checklist.png)
...
![Nyquist 图手绘检查单](/course-runtime/lessons/2-4/media/2-4-fd-10-nyquist-sketch-checklist.png)
...
![典型环节 Bode 图比较](/course-runtime/lessons/2-4/media/2-4-fd-03-typical-elements-bode-comparison.svg){ width=88% }

对二阶振荡对象而言，图形里最关键的现象是“是否有峰起、峰起有多明显”。
阻尼越小，幅值峰越突出；阻尼越大，图形越平。

![二阶振荡环节阻尼变化下的 Bode 图](/course-runtime/lessons/2-4/media/2-4-fd-07-second-order-damping-bode.svg){ width=82% }
...
![本讲信息图总结](/course-runtime/lessons/2-4/media/2-4-info.png)
