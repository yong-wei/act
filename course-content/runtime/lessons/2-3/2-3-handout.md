...
![船舶航向系统对低频指令与高频扰动的不同反应示意图](/course-runtime/lessons/2-3/media/2-3-fr-01-command-vs-disturbance.svg){width=100%}
...
![方波谐波分解与系统滤波后重构效果示意图](/course-runtime/lessons/2-3/media/2-3-fr-02-square-wave-harmonics.svg){width=100%}
...
![正弦输入与正弦稳态输出的幅值与相位对比](/course-runtime/lessons/2-3/media/2-3-fr-03-sine-in-sine-out.svg){width=100%}
...
![本讲知识点总结示意图](/course-runtime/lessons/2-3/media/2-3-info.png){fig-pos="H"}
