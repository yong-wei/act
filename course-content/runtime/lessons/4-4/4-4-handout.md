...
| 速度优先 $A$ | $[0.40,0.30,0.20,0.10]$ | $C_A(s)=2.1734\dfrac{9.6303s+1}{1.8344s+1}$ | 13.1 | 27.839 | 11.348 | 143.181 |
| 平衡权重 $B$ | $[0.30,0.30,0.20,0.20]$ | $C_B(s)=2.2249\dfrac{10.0260s+1}{1.9129s+1}$ | 12.4 | 24.145 | 10.665 | 154.550 |
| 能量优先 $C$ | $[0.20,0.25,0.25,0.30]$ | $C_C(s)=2.1490\dfrac{9.7724s+1}{1.9121s+1}$ | 13.1 | 27.412 | 11.545 | 138.352 |
