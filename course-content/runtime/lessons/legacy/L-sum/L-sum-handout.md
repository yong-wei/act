...
![图1：复平面可行域——超调量约束](/course-runtime/lessons/legacy/L-sum/media/sh-01-feasible-region-mp.svg)
...
![图2：复平面可行域——调节时间约束](/course-runtime/lessons/legacy/L-sum/media/sh-02-feasible-region-ts.svg)
...
![图3：复平面可行域全图](/course-runtime/lessons/legacy/L-sum/media/sh-03-feasible-region-full.svg)
...
![图4：根轨迹上的可行弧段](/course-runtime/lessons/legacy/L-sum/media/h-04-root-locus-feasible-arc.svg)
...
![图5：时域响应包络](/course-runtime/lessons/legacy/L-sum/media/h-05-time-domain-envelope.svg)
...
![图6：频域可行带](/course-runtime/lessons/legacy/L-sum/media/h-06-bode-feasible-band.svg)
...
![图7：例题1根轨迹图](/course-runtime/lessons/legacy/L-sum/media/h-07-example1-root-locus.svg)
...
![图8：可行域收窄对比](/course-runtime/lessons/legacy/L-sum/media/h-08-feasible-region-comparison.svg)
