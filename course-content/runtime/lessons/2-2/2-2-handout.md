...
![典型输入信号及响应对象对比曲线](/course-runtime/lessons/2-2/media/2-2-td-01-time-domain-input-response-overview.svg){width=100%}
...
![一阶系统单位阶跃响应与时间常数对比曲线](/course-runtime/lessons/2-2/media/2-2-td-02-first-order-step-time-constant.svg){width=100%}
...
![二阶系统四种典型响应形态对比图](/course-runtime/lessons/2-2/media/2-2-td-03-second-order-response-families.svg){width=100%}
...
![动态性能指标标注示意图](/course-runtime/lessons/2-2/media/2-2-td-04-time-domain-indices-annotated.svg){width=100%}
...
![例题一单位阶跃响应与性能指标标注图](/course-runtime/lessons/2-2/media/2-2-td-05-example-response-with-indices.svg){width=100%}
...
![由时域指标反推极点约束区域示意图](/course-runtime/lessons/2-2/media/2-2-td-06-time-spec-to-pole-region.svg){width=100%}
