...
![闭环控制系统的基本方框图结构，包含比较点、控制器、执行器、对象和传感器五个环节，箭头标注信号流动方向](/course-runtime/lessons/1-1/media/1-1-block-diagram-basic.png){width=85%}
...
![一阶对象根轨迹图，显示增益增大时闭环极点从开环极点出发并沿实轴向左移动](/course-runtime/lessons/1-1/media/1-1-root-locus-example.png){width=80%}
