...
![封面漫画：从真实对象到统一分析对象](/course-runtime/lessons/2-1/media/2-1-cover-comic.png){fig-pos="H" width=100%}
...
![串联连接的方框图与等效化简结果](/course-runtime/lessons/2-1/media/2-1-md-02-series-equivalent.png){width=52%}
...
![并联连接的方框图与等效化简结果](/course-runtime/lessons/2-1/media/2-1-md-03-parallel-equivalent.png){width=66%}
...
![负反馈连接的方框图与闭环等效结果](/course-runtime/lessons/2-1/media/2-1-md-04-feedback-equivalent.png){width=52%}
...
![船舶航向闭环系统的物理对象标注方框图](/course-runtime/lessons/2-1/media/2-1-md-05-ship-heading-physical-blocks.png){fig-pos="H" width=50%}
...
![方框图与对应信号流图的对照示意](/course-runtime/lessons/2-1/media/2-1-md-06-block-vs-sfg.png){width=100%}
...
![代表性例题的船舶航向闭环结构图](/course-runtime/lessons/2-1/media/2-1-md-07-example-ship-loop.png){width=80%}
...
![代表性例题对应的信号流图](/course-runtime/lessons/2-1/media/2-1-md-08-example-ship-sfg.png){width=100%}
...
![本讲信息图总结](/course-runtime/lessons/2-1/media/2-1-info.png){fig-pos="H" width=100%}
