...
![封面漫画：单元导入](/course-runtime/lessons/3-9/media/3-9-cover-comic.png)
...
![基准版本 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-baseline-quad.png)
...
这组控制器的选择依据有两条。第一，基准版的相角裕度只有 `37.43°`，说明继续追求更快响应时，中频相位必须先补出来；第二，新增零点放在 `-0.08`，与基准闭环共轭极点实部的量级接近，能更直接地把根轨迹向左拉开，同时再放一个高频极点 `-0.5`，避免高频放大过早失控。

设计过程概括为三步：

1. 保留原增益 `2.25` 作为比较基线，不让“增益变化”掩盖“零点补偿”本身的作用。
2. 把零点放在基准共轭极点实部附近，让主要振荡模态优先左移，动态改善能在根轨迹上直接看见。
...
![零点线补强 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-zero-line-quad.png)
...
![弱积分 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-integral-weak-quad.png)
...
![强积分 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-integral-strong-quad.png)
...
![积分校正 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-integral-corrected-quad.png)
...
![滞后对照 2x2 跨域图](/course-runtime/lessons/3-9/media/3-9-lag-quad.png)
...
![本讲信息图总结](/course-runtime/lessons/3-9/media/3-9-info.png)
