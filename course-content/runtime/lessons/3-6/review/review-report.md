...
## 审查范围
- 课型：实践
- `course-content/authoring/lessons/3-6/design/3-6-handout.md`
- `course-content/authoring/lessons/3-6/design/3-6-interactive-page.md`
- `course-content/authoring/lessons/3-6/design/3-6-boppps.md`

## 文本技术审查
- 未发现阻塞导出的公式配对问题。

## BOPPPS 对照
- 已将 `design/3-6-boppps.md` 作为 runtime/review 产物导出，供课程制作技能直接读取。
