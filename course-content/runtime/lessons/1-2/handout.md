...
![结构图基本元素示意图](/course-runtime/lessons/1-2/media/sh-01-block-diagram-elements.svg)
...
![船舶航向控制系统结构图](/course-runtime/lessons/1-2/media/sh-02-ship-heading-control.svg)
...
![等效变换规则对照图](/course-runtime/lessons/1-2/media/sh-03-equivalent-transform-rules.svg)
...
![信号流图示例](/course-runtime/lessons/1-2/media/sh-04-signal-flow-graph.svg)
