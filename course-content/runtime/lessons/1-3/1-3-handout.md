...
![封面漫画：参数变化与极点迁移](/course-runtime/lessons/1-3/media/1-3-cover-comic.png)
...
![开环系统在三组增益下的单位阶跃响应，三条曲线保持相同形态并按增益成比例缩放](/course-runtime/lessons/1-3/media/1-3-fig-01-open-loop-scaling.png){width=60%}
...
![开环与单位负反馈闭环结构对照，闭环结构使增益进入特征方程](/course-runtime/lessons/1-3/media/1-3-fig-02-open-closed-loop.png){width=90%}
...
![三组比例增益对应的单位负反馈闭环阶跃响应，并标出稳态值与正负5%误差带](/course-runtime/lessons/1-3/media/1-3-fig-03-closed-loop-responses.png){width=60%}
...
![单位负反馈闭环根轨迹，两支轨迹从0和-4沿实轴会合于-2，再沿实部为-2的竖直方向分离；虚轴单独位于实部0处](/course-runtime/lessons/1-3/media/1-3-fig-04-root-locus.png){width=60%}
...
![单元封底信息图：参数变化与极点迁移——根轨迹的第一眼](/course-runtime/lessons/1-3/media/1-3-info.png)
