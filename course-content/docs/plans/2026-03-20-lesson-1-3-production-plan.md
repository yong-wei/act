...
- Read: `authoring/lessons/1-2/manifest.json`
- Read: `authoring/lessons/1-2/graph/nodes.jsonl`
- Read: `authoring/lessons/1-2/graph/relations.jsonl`
- Read: `authoring/lessons/1-2/design/boppps.md`
- Read: `authoring/lessons/1-2/design/interactive-page.md`
- Read: `authoring/lessons/1-2/design/multimedia.md`
...
**Files:**
- Create: `authoring/lessons/1-3/manifest.json`
- Create: `authoring/lessons/1-3/graph/nodes.jsonl`
- Create: `authoring/lessons/1-3/graph/relations.jsonl`
- Modify/Create: `authoring/knowledge/cards/lessons/1-3/sequence.json`
...
**Files:**
- Create: `authoring/lessons/1-3/design/boppps.md`
...
**Files:**
- Create: `authoring/lessons/1-3/design/interactive-page.md`
...
**Files:**
- Create: `authoring/lessons/1-3/design/multimedia.md`
