...
新增内容写入 staging 文件（data/new_nodes.jsonl, data/new_relations.jsonl），
不修改原始数据文件，保持数据安全。
...
REL_FILE = ROOT / "data" / "relations.jsonl"
NEW_NODES_FILE = ROOT / "data" / "new_nodes.jsonl"
NEW_RELS_FILE = ROOT / "data" / "new_relations.jsonl"
