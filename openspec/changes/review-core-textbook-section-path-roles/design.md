...
- Completion evidence is scoped: `remaining:0` applies to the selected core-textbook section queue/shard, not to the whole textbook-section universe unless that full queue was selected.
