...
- [x] Task 1: Generate analysis/design binding worklist.
  Covers: AC-1
...
- [x] Task 2: Manually review and bind analysis/design resources.
  Covers: AC-1, AC-2
...
- [x] Task 3: Validate affected LearningGoal baseline coverage.
  Covers: AC-2, AC-3
...
- [x] Run `rtk openspec validate complete-analysis-design-graph-resource-bindings --strict`.
