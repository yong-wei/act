...
The completed tasks publish review evidence only. They do not establish CourseCoverage authority: all 10 members are `DEFER`, the receipt is `DEFERRED_EVIDENCE_BLOCKED`, and the global aggregate gate remains blocked pending independent course evidence and any required re-freeze.
