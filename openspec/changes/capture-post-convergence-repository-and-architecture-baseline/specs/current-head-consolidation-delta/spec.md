...
#### Scenario: Capture identity is dirty, mixed, stale, or unresolved
...
#### Scenario: A cross-domain surface or derived architecture slice is inventoried
...
#### Scenario: Only a historical artifact or archive reference mentions a surface
