...
- [x] 1. Select the assessment shard.
...
- [x] 2. Review existing candidate items item by item.
...
- [x] 3. Author minimum new shard items only when needed.
