...
- [ ] 3.5 Resolve final Commercial UI governance findings caused by this change: register the prompt-assessment route and remove its page-level maximum-width wrapper, then refresh fixed-revision browser evidence.
