...
- [ ] 3.5 Resolve final Commercial UI governance findings caused by this change: register the prompt-assessment route, integrate its page with the platform shell, and publish its fixed-revision browser evidence to the global Commercial UI manifest.
