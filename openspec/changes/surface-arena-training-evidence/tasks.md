...
- [x] 2.1 Add failing profile analytics tests for separate virtual-training records, task attribution, and unchanged official submission aggregates.
...
- [x] 3.2 Run strict OpenSpec validation and inspect the diff for unrelated official evaluation, leaderboard, progress, and historical evidence changes.
