...
After primary resource-family batches, any remaining missing human-review or disposition findings must be closed before the final gate can assert all existing resources are accounted for.
