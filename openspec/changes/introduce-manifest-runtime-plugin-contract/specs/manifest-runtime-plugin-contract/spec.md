...
Define typed, owned plugins for manifest module kinds, activity behavior, and
layout/template rendering without merging the manifest registry with the DB
TeachingResource registry or retaining a giant central business switch.
