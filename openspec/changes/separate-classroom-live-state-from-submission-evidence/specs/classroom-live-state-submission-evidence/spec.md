...
Define the boundary between overwriteable classroom live projections and
append-oriented submission evidence, including concurrency, preview isolation,
and post-class closure.
