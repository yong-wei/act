...
- Manual boundary: [2026-07-22 real-provider record](../../../docs/operations/evidence/2026-07-22-smart-courseware-real-provider-root-locus.md) verifies the authenticated local Konling, source-import, and teacher-confirmation path without a fixture or backup revision. The configured external Provider entered `RETRYABLE` at the real plan OUTLINE stage before publication; 3.2 therefore remains unchecked. Deterministic fixture evidence is not treated as real-provider evidence.
