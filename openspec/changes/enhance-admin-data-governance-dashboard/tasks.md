...
- [ ] 1.1 Add admin endpoints for session quality, source coverage, and cache health.
- [ ] 1.2 Update admin data governance UI tabs.
- [ ] 1.3 Reuse existing report services and source catalog logic.
- [ ] 1.4 Add tests for endpoint authorization and report payload shape.
