...
- [x] 5.3 Add browser or Playwright acceptance for student profile/growth, teacher student detail, and teacher class insight with cumulative data, partial coverage, no eligible evidence, reconciliation states, and subordinate goal-specific diagnosis.
- [x] 5.4 Run focused suites, data-governance tests, Prisma migration and queue-invalidation validation, typecheck, build, strict OpenSpec validation, and the required independent/domain reviews before the pull request.
