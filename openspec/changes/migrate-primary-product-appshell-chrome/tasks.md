...
- [ ] 1. Normalize primary route metadata.
...
- [ ] 2. Centralize primary header actions.
...
- [ ] 3. Add breadcrumbs to primary modules.
...
- [ ] 4. Move local commands to local tool areas.
