...
- [ ] 1.1 Add a tag-tree mirror tool that records the v0.18 publication/source
  commits, Git objects, file modes, raw hashes, Manifest, and Bundle digest.
- [ ] 1.2 Mirror the complete pinned package into a controlled immutable ACT
...
- [ ] 2.1 Extend the standard import boundary for the typed v2 result without
...
- [ ] 3.1 Rebuild the mirror, candidate, and impact evidence twice from a clean
  capture and require byte-identical outputs.
