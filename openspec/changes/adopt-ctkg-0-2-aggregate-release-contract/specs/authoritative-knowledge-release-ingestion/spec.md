...
#### Scenario: Locked aggregate package is admitted
...
#### Scenario: Unlocked, parallel, or drifted package is rejected
...
#### Scenario: CTKG 0.2 contract passes
...
#### Scenario: Public-bundle round trip runs
...
#### Scenario: Aggregate candidate import completes
...
#### Scenario: Importer attempts to reconstruct private lineage
...
#### Scenario: Aggregate bundle has no registry reference
...
#### Scenario: A future adapted bundle carries a registry reference
