...
- `change_id`: `review-course-coverage-c3fa63179e847ed1f2e2b6c1`
- `batchId`: `c3fa63179e847ed1f2e2b6c1`
- `manifestBatchIndex`: `1`
- `sequence`: `0`
- `semanticGroupKey`: `ctr:release:classical-control-design-engineering-v0.1::entityType:Formula`
- `memberCount`: `98`
- `memberDigest`: `ceebf1c62b71689304b36603dbd3da2e76a5b15ac08102f969441021c7f3d933`
...
- `exactOrderedMembers`: `batch-manifest.json#/batches/1/members`
