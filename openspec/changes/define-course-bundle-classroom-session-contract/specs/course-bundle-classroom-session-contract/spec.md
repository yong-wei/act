...
Define the immutable CourseBundle revision identity that binds runtime content
to a Classroom session without reading authoring content or inferring identity
from mutable plan titles.
