...
- [ ] 1.1 Extend evidence summary item model and newest-first generation.
- [ ] 1.2 Add student and teacher evidence browse APIs with filters and cursor pagination.
- [ ] 1.3 Update growth, student detail, and diagnosis pages to use newest summaries and browsing entry points.
- [ ] 1.4 Add tests for ordering, filters, and access control.
