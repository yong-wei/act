...
- [x] 1.1 Extend evidence summary item model and newest-first generation.
- [x] 1.2 Add student and teacher evidence browse APIs with filters and cursor pagination.
- [x] 1.3 Update growth, student detail, and diagnosis pages to use newest summaries and browsing entry points.
- [x] 1.4 Add tests for ordering, filters, and access control.
