...
- [ ] Task 3: Preserve layout stability and user pins.
  Covers: AC-4
...
- [ ] Task 4: Keep 2D and 3D graph modes coherent.
  Covers: AC-5
...
- [ ] Task 5: Run visual and accessibility validation.
  Covers: AC-6
...
- [ ] Task 6: Run OpenSpec and Buddy validation.
  Covers: AC-7
...
- [ ] Run `rtk openspec validate improve-knowledge-graph-node-expansion-interaction --strict`.
- [ ] Run focused tests for knowledge graph expansion interaction and layout.
- [ ] Run browser visual verification for `/knowledge` with a top-level unit node selected, expanded, and collapsed.
