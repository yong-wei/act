...
- [x] 4.4 On a clean committed revision, run one full local app-only release image build and verify OCI revision, tar SHA-256, provenance sidecar, Chromium, and LibreOffice; do not deploy.
