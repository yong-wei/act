...
- 本变更依赖 `adopt-ctkg-0-2-aggregate-release-contract` 和 `govern-aggregate-course-coverage-and-resource-bindings`，并只在聚合 ReleaseSet、CourseCoverage 与 ACT Crosswalk 版本一致时以影子方式验证。
