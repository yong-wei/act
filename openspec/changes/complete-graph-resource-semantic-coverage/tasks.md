...
- [ ] 1. Run the completeness helper and define the resource completion batch.
...
- [ ] 4. Preserve citation-only boundaries.
...
- [ ] 5. Regenerate runtime governance artifacts and rerun readiness checks.
  - Rebuild field completion audit, runtime projections, baseline matrices, and any affected Source Pack/RAG artifacts.

- [ ] 6. Add targeted path planning and Konling citation tests.
