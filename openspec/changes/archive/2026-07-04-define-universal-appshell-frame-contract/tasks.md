...
- [x] 1. Define the universal AppShell route contract.
...
- [x] 2. Add route exception inventory.
...
- [x] 3. Normalize AppShell header action ownership.
...
- [x] 4. Normalize route navigation metadata.
...
- [x] 5. Add static shell coverage tests.
