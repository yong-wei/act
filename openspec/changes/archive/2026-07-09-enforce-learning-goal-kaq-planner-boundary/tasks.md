...
- [x] Task 1: Build LearningGoal K/A/Q boundary extraction for the planner.
  Covers: AC-1
...
- [x] Task 2: Enforce candidate filtering by reviewed objective or graph fit.
  Covers: AC-1, AC-2
...
- [x] Task 3: Add objective-boundary diagnostics.
  Covers: AC-3
...
- [x] Task 4: Validate all registered LearningGoals.
  Covers: AC-4
...
- [x] Task 5: Run OpenSpec and Buddy validation.
  Covers: AC-5
...
- [x] Run `rtk openspec validate enforce-learning-goal-kaq-planner-boundary --strict`.
- [x] Run focused all-LearningGoal planner diagnostics and candidate-boundary tests.
