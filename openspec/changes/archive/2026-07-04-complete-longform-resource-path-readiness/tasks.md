...
- [x] 1. Run helper and inventory all in-scope long-form resource gaps.
...
- [x] 2. Manually classify long-form dispositions.
...
- [x] 3. Complete reviewed section metadata.
