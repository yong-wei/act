...
- [x] 1. Define the persisted SAR index schema and retention boundaries.
...
- [x] 2. Implement idempotent SAR persistence and safe trace serialization.
...
- [x] 3. Define and enforce query trace retention/minimization.
...
- [x] 4. Add privacy and durability tests.
