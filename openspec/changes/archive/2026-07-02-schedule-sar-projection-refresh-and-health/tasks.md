...
- [x] 1. Define SAR refresh source families and health status contract.
  - Include source versions, last refresh timestamps, stale counts, failures, retries, and limitations.

- [x] 2. Implement refresh orchestration over persisted SAR records.
...
- [x] 3. Surface SAR refresh health to administrators.
