...
- [x] 1. Classify all second-level and deeper routes.
...
- [x] 2. Migrate course and lesson runtime routes.
  - Ensure course entry and waiting pages keep the canonical rail and top bar.
  - Preserve legacy student/teacher runtime pages as narrow governed exceptions until each course adopts `LessonRuntimeShell`.
  - Preserve immersive teaching controls as local tools, not shell replacements.

- [x] 3. Migrate classroom, AI, playlist, and legacy student routes.
  - Wrap routes or route groups with AppShell-compatible shells.
  - Add breadcrumbs and active top-level navigation mapping.
  - Keep live classroom student/teacher/review routes as narrow governed exceptions until a classroom runtime shell exists.

- [x] 4. Migrate teacher, administrator, data-center, graph-center, virtual-lab, and older interactive pages.
...
- [x] 5. Add deep-route coverage tests.
