...
- `change_id`: `review-course-coverage-88b4b69695891faeed019fb2`
- `batchId`: `88b4b69695891faeed019fb2`
- `manifestBatchIndex`: `29`
- `sequence`: `0`
- `semanticGroupKey`: `ctr:release:time-domain-analysis-engineering-v0.1::entityType:SystemModel`
- `memberCount`: `25`
- `memberDigest`: `d3da297e9f913499949a12a9622615455ed95a206ed2ffca144d29e0de49a36a`
...
- `exactOrderedMembers`: `batch-manifest.json#/batches/29/members`
