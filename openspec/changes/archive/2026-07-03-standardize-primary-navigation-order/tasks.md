...
- [x] 1. Define the canonical primary navigation order in the central navigation layer.
...
- [x] 2. Wire primary consumers to the canonical order.
...
- [x] 3. Add navigation-order validation.
