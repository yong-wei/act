...
- [x] 1.3 Verify replay fixtures cover clean, dirty/mixed, tree drift, stale/duplicate receipts, denominator/privacy conflict and qualified/blocked/unresolved states.（本轮补齐 mixed-worktree 与 stale-receipt tree-drift 两个 fixture 后：independent-toolchain-execution-boundary 13 项（dirty、mixed、stale tree-drift、duplicate owner、privacy、fail-close）+ tooling-cli-inventory 14 项（dirty-guard、workspace/HEAD 双比对 drift））
