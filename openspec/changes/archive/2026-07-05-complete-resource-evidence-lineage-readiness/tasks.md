...
- [x] 1. Run helper after core, long-form, and assessment item resources are reviewed, then isolate path-relevant evidence-lineage blockers.
...
- [x] 2. Complete evidence contracts for path-relevant resource types.
  - Define event type, clientEventId, attemptKey, source log, dedupe, timestamp, LearningFact, confidence, and privacy behavior.

- [x] 3. Repair instrumentation and materialization gaps.
...
- [x] 4. Add evidence-lineage tests.
