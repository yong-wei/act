...
- [x] Task 1: Generate LearningGoal assessment worklists.
  Covers: AC-1
...
- [x] Task 2: Review and classify existing items item by item.
  Covers: AC-1, AC-3
...
- [x] Task 3: Author minimal new checkpoint/remediation/terminal-validation where required items where needed.
...
- [x] Task 4: Validate assessment baseline completeness.
  Covers: AC-1, AC-2, AC-3
...
- [x] Run `rtk openspec validate complete-learning-goal-assessment-baselines --strict`.
