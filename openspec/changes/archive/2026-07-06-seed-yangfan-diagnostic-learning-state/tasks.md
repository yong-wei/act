...
- [x] 1. Add fixture precondition checks.
...
- [x] 2. Resolve canonical and duplicate Yang Fan accounts.
  - Identify the canonical email/student-number account, report duplicate candidates, and block apply/reset until duplicate accounts are resolved by a separate human-reviewed operation.

- [x] 3. Materialize Yang Fan learning evidence.
...
- [x] 4. Add fixture reset and dry-run/apply modes.
...
- [x] 5. Add end-to-end diagnostic tests.
