...
- [x] 1. Add a SAR diagnostics entry point to the admin data-governance surface.
...
- [x] 2. Preserve SAR privacy boundaries in the visible UI.
...
- [x] 3. Clean up the archived SAR spec Purpose.
  - Replace the placeholder `TBD` Purpose with a stable description of SAR's governed role and boundaries.

- [x] 4. Add focused tests for the admin SAR diagnostics surface.
