...
- [x] Task 1: Generate residual graph-node workqueue.
  Covers: AC-1
...
- [x] Task 2: Bind remaining graph nodes item by item or create reviewed gaps.
  Covers: AC-1, AC-2
...
- [x] Task 3: Validate graph coverage closure.
  Covers: AC-2, AC-3
...
- [x] Run `rtk openspec validate close-graph-resource-coverage-backlog --strict`.
- [x] Run the data-completeness helper and preserve before/after graph-node-resource-missing totals.
