...
- [x] 1.1 Add Prisma models or migrations for assessment sessions, selected question state, answers, item references, ability estimates, mastery updates, and algorithm versions.
...
- [x] 3.1 Add tests for restart survival, non-repeating durable next-question selection, generated question metadata restoration, reproducible ability/mastery updates, privacy-safe payloads, and LearningFact materialization.
