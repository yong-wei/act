...
- [x] Reject stripped or retained-binding protocol downgrade and reseal attacks while preserving only the fifteen exact tracked historical receipt/attestation path-and-digest pairs.
