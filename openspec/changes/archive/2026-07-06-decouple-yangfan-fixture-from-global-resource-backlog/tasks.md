...
- [x] 1. Define scoped fixture resource-set readiness.
...
- [x] 2. Update helper policy and diagnostics.
...
- [x] 3. Add guardrails for limited fixture coverage.
...
- [x] 4. Validate fixture-readiness behavior.
