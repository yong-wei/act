...
- [x] Task 1: Define the primary portrait v2 learner-state contract.
  Covers: AC-1
...
- [x] Task 2: Add primary portrait v2 persistence/write contract.
  Covers: AC-2
...
- [x] Task 3: Mark legacy six-dimensional vectors as compatibility-only.
  Covers: AC-3
...
- [x] Task 4: Add privacy-scoped source lineage rules.
  Covers: AC-4
...
- [x] Run `rtk openspec validate define-portrait-v2-primary-model --strict`.
- [x] Run the focused portrait model contract tests added by the implementation.
