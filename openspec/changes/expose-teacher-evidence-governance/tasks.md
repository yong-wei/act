...
- [ ] 1.1 Extend class insights API with feature cache coverage and student evidence fields.
- [ ] 1.2 Extend student insights API with evidence drawer summaries.
- [ ] 1.3 Update teacher UI for evidence state, recent session quality, and evidence drawer.
- [ ] 1.4 Add access control and payload-limit tests.
