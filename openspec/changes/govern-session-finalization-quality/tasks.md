...
- [ ] 1.1 Implement shared finalization service.
- [ ] 1.2 Migrate module 5 finalization callers.
- [ ] 1.3 Add post-class closure phase reporting.
- [ ] 1.4 Add tests for successful and partially failed closure.
