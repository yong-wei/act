...
- `npx vitest run src/app/__tests__/portfolio-reflection-drafts-route.test.ts src/lib/__tests__/portfolio-reflection-draft-contracts.test.ts src/lib/__tests__/ai-task-boundary-ui-source.test.ts` (11 tests passed)
