...
- **THEN** Konling SHALL call the governed planner tool with server-owned LearningGoal package, graph subgoal, learner, class, resource, path, and privacy context
