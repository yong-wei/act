...
- [x] 4.4 Capture commit-bound Commercial UI Evidence for explicit selection, ambiguity, success, failure/retry, deep-link focus, keyboard focus, responsive layout, and no horizontal overflow.
