...
- [x] 1.1 Create or replace the all-course manifest submission gate inventory.
- [x] 1.2 Wire CourseEvidenceSpec lookups into gate tests where useful.
- [x] 1.3 Add tests for all runtime-first lessons and a failing bypass fixture.
- [x] 1.4 Run npm run test:course-data-quality-gates.
