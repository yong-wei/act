...
- [ ] 1.1 Extend backfill dry-run and apply summaries for legacy course evidence.
- [ ] 1.2 Support scoped session or lesson recovery and report regeneration.
- [ ] 1.3 Preserve final-state-enriched quality and trace metadata.
- [ ] 1.4 Run dry-run and targeted tests before any apply.
