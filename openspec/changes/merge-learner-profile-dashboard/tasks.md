...
- [x] 1. Define `/profile` as canonical Personal Center routing.
...
- [x] 2. Merge dashboard and profile modules.
...
- [x] 3. Consolidate data loading and states.
...
- [x] 4. Validate navigation and visual behavior.
