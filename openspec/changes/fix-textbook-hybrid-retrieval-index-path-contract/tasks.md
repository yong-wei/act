...
- [x] 3.1 使用现有缓存重建 `course-content/runtime/resources/textbook-hybrid-retrieval/bge-m3`
- [x] 3.2 运行 `textbook_hybrid_retrieval.py verify-index` 验证索引与 `textbooks-v2` 一致
...
- [x] 4.4 增加真实 canonical 索引 smoke test，验证普通与渐进式检索返回非空 `candidate.text`
