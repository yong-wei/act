...
- [ ] Task 1: Implement portrait v2 incremental update engine.
  Covers: AC-1, AC-2
...
- [ ] Task 2: Update the student snapshot worker to use incremental semantics.
  Covers: AC-2, AC-3
...
- [ ] Task 3: Add regression coverage for sparse and stale evidence.
  Covers: AC-3, AC-4
...
- [ ] Run `rtk openspec validate stabilize-portrait-incremental-updates --strict`.
- [ ] Run focused data-governance worker and portrait update tests.
