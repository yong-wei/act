...
- [ ] 1.1 Add evidenceStatus to /api/user/profile.
- [ ] 1.2 Update student profile and recommendation card mapping.
- [ ] 1.3 Add tests for ready, stale, and missing cache states.
- [ ] 1.4 Verify low-confidence recommendations remain labeled.
