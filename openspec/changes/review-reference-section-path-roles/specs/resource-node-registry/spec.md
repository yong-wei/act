...
- **AND** path promotion SHALL require graph mapping, LearningGoal fit, source authority, estimated time, citation address, privacy policy, source hash, and human review metadata.
