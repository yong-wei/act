...
- [x] 4.1 Implement a host-locked temporary materializer that creates a read-only logical runtime view solely from one verified blob-backed manifest and atomically selects it only after validation.
