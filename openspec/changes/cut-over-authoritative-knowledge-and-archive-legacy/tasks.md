...
- [ ] 2.1 Implement one Cutover Gate covering graph API, Konling, RAG, SAR, KAQ, effective resources, CourseCoverage, paths, Canonical writers, complete course ReleaseSet, and Teaching Projection.
