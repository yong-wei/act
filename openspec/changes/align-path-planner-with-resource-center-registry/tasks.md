...
- [x] Task 1: Replace partial path-generation registry loading with the unified ResourceNode registry projection.
  Covers: AC-1, AC-2
...
- [x] Task 2: Add candidate-pool diagnostics.
  Covers: AC-2
...
- [x] Task 3: Preserve PlanningUnit boundaries.
  Covers: AC-3
...
- [x] Task 4: Validate OpenSpec and planner tests.
  Covers: AC-4
...
- [x] Run `rtk openspec validate align-path-planner-with-resource-center-registry --strict`.
- [x] Run focused path planner and ResourceNode registry tests.
