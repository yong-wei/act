...
- [ ] Task 2: Enforce reviewed semantic completeness for new resources.
  Covers: AC-1, AC-2
...
- [ ] Task 3: Wire the gate into local hook setup and future CI command.
  Covers: AC-3
...
- [ ] Task 4: Validate OpenSpec, issue body, and targeted tests.
  Covers: AC-4
...
- [ ] Run `rtk openspec validate gate-new-resource-semantic-completeness --strict`.
- [ ] Run targeted data-governance tests for the new-resource gate.
