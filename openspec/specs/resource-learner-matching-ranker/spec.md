# resource-learner-matching-ranker Specification

## Purpose
Define governed, graph-aware resource ranking semantics for adaptive paths, Konling advice, diagnosis, and teacher prep-pack candidate selection.
