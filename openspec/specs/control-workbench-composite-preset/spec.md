# control-workbench-composite-preset Specification

## Purpose
Define the composite-control workbench preset used by block-diagram Arena challenges, including bounded template parameters, structure summaries, and official composite-compensation artifact submission.
