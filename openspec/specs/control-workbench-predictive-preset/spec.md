# control-workbench-predictive-preset Specification

## Purpose
Define the predictive-control workbench preset used by Arena tasks that submit bounded MPC and optimization-assisted PID templates, including local preview boundaries and official-only hidden metrics.
