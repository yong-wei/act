# actkg-v022-runtime-release Specification

## Purpose
Publish an envelope-configurable runtime that can serve the current production envelope and read a qualified v0.22 shadow without moving shared selectors.
## Requirements
