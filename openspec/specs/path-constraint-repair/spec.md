# path-constraint-repair Specification

## Purpose
Define bounded, explainable path repair for graph-driven adaptive paths, including checkpoint coverage, terminal validation coverage, and structured infeasible output without making a solver dependency mandatory.
