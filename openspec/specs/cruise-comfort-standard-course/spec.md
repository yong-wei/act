...
Cruise-comfort BOPPPS keeps the public route `/interactive-learning/courses/cruise-comfort-boppps` while using the standard runtime-first interactive course model, manifest submission evidence, and unified teacher session finalization path.
## Requirements
