# qa-evidence-artifact-lifecycle Specification

## Purpose
Classify QA evidence, keep fixtures and manifests in the repository, externalize run-specific screenshots with hashed deletion receipts, and forbid product imports of artifacts/.
## Requirements
