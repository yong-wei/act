## Purpose
Arena Pro needs student-facing competition views that make multiple leaderboard styles, official-result honors, and excellent-solution showcases visible without exposing private controller payloads by default.
