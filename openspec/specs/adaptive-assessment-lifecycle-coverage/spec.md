# adaptive-assessment-lifecycle-coverage Specification

## Purpose
TBD - created by archiving change extend-adaptive-assessment-lifecycle-coverage-v2. Update Purpose after archive.
## Requirements
