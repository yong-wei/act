# modular-domain-dependency-contracts Specification

## Purpose
TBD - created by archiving change enforce-modular-domain-dependency-contracts. Update Purpose after archive.
## Requirements
