# audit-remediation-data-center-simulation-workflow Specification

## Purpose
Define the audited workflow contracts for Data Center role/source boundaries, export-safe snapshots, simulation task context preservation, visible simulation tools, and compatibility-route recovery.
## Requirements
...
- **AND** the exported snapshot SHALL declare source table families, source window, source quality state, requester role, and redaction policy.
