...
The platform SHALL use the “智控深蓝” identity as the homepage primary brand lockup, paired with the platform description “基于学科垂类大模型的船舶智控教学平台”.

#### Scenario: Homepage brand renders
- **WHEN** the homepage topbar renders
- **THEN** it SHALL show a governed “智控深蓝” calligraphic art logo and the Chinese platform description
...
- **WHEN** the “智控深蓝” logo asset is introduced
...
- **WHEN** homepage code renders the “智控深蓝” lockup
