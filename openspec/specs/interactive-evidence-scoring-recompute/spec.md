...
Provide a controlled, auditable path to recompute historical manifest objective
scoring context from durable interactive evidence after scoring semantics
change.
## Requirements
