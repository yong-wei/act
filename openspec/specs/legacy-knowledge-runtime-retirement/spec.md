# legacy-knowledge-runtime-retirement Specification

## Purpose
Evidence-gated retirement of obsolete legacy knowledge runtime dependencies (graph/card readers, global CourseCoverage selector, production dual-authority fallbacks) while retaining audit manifests, crosswalks, historical snapshots, and LearningFact compatibility adapters.
## Requirements
