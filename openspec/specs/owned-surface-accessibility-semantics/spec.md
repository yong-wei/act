...
Owned application surfaces maintain warning-level accessibility and DOM semantics as product quality requirements. Controls must expose their intent, accessible names, and keyboard behavior without changing intentional form submission flows.
## Requirements
