...
Define the canonical identity contract for runtime-first interactive lessons so
classroom routing, runtime lookup, evidence governance, submission gates, and AI
context lookup resolve the same lesson through one shared registry.
