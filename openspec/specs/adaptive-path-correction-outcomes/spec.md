# adaptive-path-correction-outcomes Specification

## Purpose
Defines evidence-bounded outcome projections for applied adaptive-path correction decisions and privacy-safe teacher aggregates without asserting causal improvement.
