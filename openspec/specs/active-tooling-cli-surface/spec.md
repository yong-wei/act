# active-tooling-cli-surface Specification

## Purpose
TBD - created by archiving change inventory-and-consolidate-active-tooling-cli-surface. Update Purpose after archive.
## Requirements
