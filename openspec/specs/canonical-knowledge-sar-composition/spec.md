# canonical-knowledge-sar-composition Specification

## Purpose
Define bounded, provenance-preserving query-time composition across Canonical knowledge, KAQ, resources, paths, and learner-state overlays while Legacy remains the formal SAR authority before cutover.
## Requirements
