# migration-backfill-competition-toolchains Specification

## Purpose
Isolate migration, historical backfill, and competition-material commands behind an apply-gated, dry-run-default boundary that never executes production writes in this change.
## Requirements
