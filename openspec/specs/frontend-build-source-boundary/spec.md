# frontend-build-source-boundary Specification

## Purpose

Define the frontend build source boundary for Tailwind CSS and Turbopack so repository system, agent, OpenSpec, documentation, generated, log, and machine-local tool directories cannot affect page CSS compilation or runtime route availability.
## Requirements
