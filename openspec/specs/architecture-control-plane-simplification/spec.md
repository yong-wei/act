# architecture-control-plane-simplification Specification

## Purpose
TBD - created by archiving change simplify-architecture-control-plane-and-active-trust-validators. Update Purpose after archive.
## Requirements
