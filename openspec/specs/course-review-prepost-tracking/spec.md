# course-review-prepost-tracking Specification

## Purpose

Define the generic teacher review pre/post tracking path so classroom review pages derive ability deltas from shared CourseEvidenceSpec mappings and preserve evidence recoverability semantics.
## Requirements
