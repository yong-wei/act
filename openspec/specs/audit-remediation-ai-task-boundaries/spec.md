...
Define AI, Prompt, Copilot, and portfolio task boundaries remediated from the full-system audit so student-visible AI surfaces expose scoped, sanitized, task-aware outputs.
## Requirements
