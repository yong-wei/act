...
### 步骤1：选择目标目录
建议迁移到以下目录之一：
- `~/Desktop/ai-obe-platform` (桌面)
- `~/Projects/ai-obe-platform` (项目目录)
- `/tmp/ai-obe-platform` (临时目录，用于测试)
...
# 2. 创建目标目录并复制项目
mkdir -p ~/Desktop/ai-obe-platform
cp -r /Users/YW/JianguoYun/Codes/Site/act.just.edu.cn/ai-obe-platform/* ~/Desktop/ai-obe-platform/

# 3. 进入新目录
cd ~/Desktop/ai-obe-platform
