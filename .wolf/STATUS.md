...
- 2026-09-07：#2044 / PR #2057 正在按根因修第二轮 Codex（P1 候选/部署修订、P2 绑定级 viewer 载荷、P2 教材 href 精确持有）。修完后一次提交推送、只请求一次复审。不要关 #1033。不要 `deploy:app` / `deploy:runtime`。不要主动调用 Claude。
