...
**Developer OSS runtime gateway (2026-08-30):** #1721 / PR #1722。实现已归档；Codex 对 `13807877d` 的 4 条 P1 与 checkout 拓扑 P2 已按规范修复，待新 HEAD 复审清场。合入前不得 `server-ops` 部署网关。不要认领 #1683，不要重开 #1573。
