...
**Coordinated v0.37-r4 cutover (2026-08-30):** #1509 活作者态已重绑 v0.37。10.2/10.3 完成。10.5 有父 `--stage-only` 已发布并物化 `runtime-150a505a…`（parent=生产 active `runtime-bb309e6a…`，inherited 7272/7277，putCount 2，NON_SELECTABLE）。overlay 已把 Git `catalog.json` 符号链接替换为父 view 普通文件。生产 current/desired 未改。下一步：本地 10.5 prepare/qualify，不要激活/部署，不要关 #1509，不要认领 #1683。
