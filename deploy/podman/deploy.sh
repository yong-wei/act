...
MATHPIX_ENDPOINT="${MATHPIX_ENDPOINT:-https://api.mathpix.com/v3/text}"
...
for env_name in \
  ...
  MATHPIX_ENDPOINT MATHPIX_CREDENTIAL_REF MATHPIX_VERSION \
  GRADING_SOURCE_ASSET_POLICY_VERSION GRADING_SOURCE_ASSET_RETENTION_SECONDS GRADING_SOURCE_ASSET_GOVERNED_RECORD_RULE GRADING_SOURCE_ASSET_DELETE_STRATEGY \
  GRADING_ANSWER_EVIDENCE_POLICY_VERSION GRADING_ANSWER_EVIDENCE_RETENTION_SECONDS GRADING_ANSWER_EVIDENCE_GOVERNED_RECORD_RULE GRADING_ANSWER_EVIDENCE_DELETE_STRATEGY \
  GRADING_DOCUMENT_CONVERSION_POLICY_VERSION GRADING_DOCUMENT_CONVERSION_RETENTION_SECONDS GRADING_DOCUMENT_CONVERSION_GOVERNED_RECORD_RULE GRADING_DOCUMENT_CONVERSION_DELETE_STRATEGY \
  GRADING_AI_DRAFT_POLICY_VERSION GRADING_AI_DRAFT_RETENTION_SECONDS GRADING_AI_DRAFT_GOVERNED_RECORD_RULE GRADING_AI_DRAFT_DELETE_STRATEGY \
  GRADING_RUN_POLICY_VERSION GRADING_RUN_RETENTION_SECONDS GRADING_RUN_GOVERNED_RECORD_RULE GRADING_RUN_DELETE_STRATEGY \
  ...
  GRADING_MATHPIX_POLICY_VERSION GRADING_MATHPIX_ENABLED GRADING_MATHPIX_DATA_CATEGORIES GRADING_MATHPIX_MINIMIZED_SCOPE; do
  if [ -n "${!env_name:-}" ]; then
