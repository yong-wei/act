...
const routeMatrix = [
  ...
  ['path-comparison-desktop-light', 'frequency-response-foundations', 'light', 'desktop', 'desktop-collapsed', 'collapsed', conceptImages[1], 'comparable path options', 'artifacts/commercial-ui/adaptive-path-product-qa-516/path-comparison-desktop-light.png'],
  ['path-comparison-mobile-dark', 'frequency-response-foundations', 'dark', 'mobile', 'workspace-command-surface', 'collapsed', conceptImages[1], 'comparable path options', 'artifacts/commercial-ui/adaptive-path-product-qa-516/path-comparison-mobile-dark.png'],
