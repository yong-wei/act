...
const routeMatrix = [
  ...
  ['konling-dock-disabled-desktop-dark', 'frequency-response-foundations', 'dark', 'desktop', 'desktop-collapsed', 'collapsed', conceptImages[0], 'disabled shared Konling dock in demo mode', 'artifacts/commercial-ui/adaptive-path-product-qa-516/konling-dock-disabled-desktop-dark.png'],
