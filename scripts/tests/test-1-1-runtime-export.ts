...
const mediaPaths = [
  ...
  'course-content/runtime/lessons/legacy/1-1/media/h-03-pole-response-family.svg',
  'course-content/runtime/lessons/legacy/1-1/media/h-04-typical-elements.svg',
  'course-content/runtime/lessons/legacy/1-1/media/h-05-rc-circuit.svg',
  'course-content/runtime/lessons/legacy/1-1/media/sh-01-mason-portrait.png',
];
...
assert.equal(
  handout.includes('/course-runtime/lessons/legacy/1-1/media/h-02-laplace-transform-flow.svg'),
  true,
  '讲义中的拉氏变换流程图应改写到 runtime 路径',
);
assert.equal(
  handout.includes('/course-runtime/lessons/legacy/1-1/media/h-04-typical-elements.svg'),
  true,
