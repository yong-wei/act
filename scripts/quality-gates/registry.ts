...
const EXTRA_COMMANDS: readonly QualityCommandDefinition[] = [
  ...
  ['test:runtime-release-deployment-contract', 'runtime-release-deployment-contract', GENERIC_COMMAND_RECEIPT_SCHEMA_VERSION, 'scripts/tests/test_publish_runtime.py', 'npm-script'],
  ['test:runtime-production-cutover-contract', 'runtime-production-cutover-contract', GENERIC_COMMAND_RECEIPT_SCHEMA_VERSION, 'scripts/tests/test_activate_runtime.py', 'npm-script'],
  ['test:runtime-release-oss-publisher-bridge', 'runtime-release-oss-publisher-contract', GENERIC_COMMAND_RECEIPT_SCHEMA_VERSION, 'scripts/tests/test_publish_runtime.py', 'npm-script'],
  ['test:runtime-release-activation-rollback', 'runtime-release-rollback-smoke', GENERIC_COMMAND_RECEIPT_SCHEMA_VERSION, 'scripts/tests/test_activate_runtime.py', 'npm-script'],
