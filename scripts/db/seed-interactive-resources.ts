...
const INTERACTIVE_RESOURCES = [
  ...
  },
  {
    ...
    title: '参数根轨迹知识卡',
    displayName: '参数根轨迹知识卡',
    description: '掌握参数根轨迹广义定义、等效开环与稳定范围判断',
    type: ResourceType.INTERACTIVE_COMP,
    category: InteractiveCategory.ROOT_LOCUS,
    displayOrder: 3,
  },
  {
    ...
    title: '图形化思考工作坊',
    displayName: '图形化思考工作坊',
    description: '通过案例训练参数根轨迹的图形化分析流程',
    type: ResourceType.INTERACTIVE_COMP,
    category: InteractiveCategory.ROOT_LOCUS,
    displayOrder: 4,
  },
...
const STATIC_MEDIA_RESOURCES = [
  ...
  },
  {
    ...
    title: '课程路线图：参数根轨迹',
    displayName: '课程路线图：参数根轨迹',
    description: '展示参数根轨迹与图形化思考的学习主线',
    type: ResourceType.STATIC_MEDIA,
    category: InteractiveCategory.ROOT_LOCUS,
    displayOrder: 7,
  ...
  },
  {
    ...
    title: '等效开环变换步骤',
    displayName: '等效开环变换步骤',
    description: '把参数变化转化为等效开环增益的步骤示意',
    type: ResourceType.STATIC_MEDIA,
    category: InteractiveCategory.ROOT_LOCUS,
    displayOrder: 8,
  ...
  },
  {
    ...
    title: '图形化思考到仿真验证',
    displayName: '图形化思考到仿真验证',
    description: '根轨迹到响应验证的图形化流程与代码示意',
    type: ResourceType.STATIC_MEDIA,
    category: InteractiveCategory.ROOT_LOCUS,
    displayOrder: 9,
